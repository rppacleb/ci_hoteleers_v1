...
use App\Models\Applicant_search_model;
use App\Models\Audit_trail_model;
use App\Libraries\Pcl_lib;
class Applicant_search extends BaseController{
	protected $model;
	protected $session;
	...
	public function __construct(){
		...
		$this->model 			= new Applicant_search_model();
    ...
    public function index($type){
			...
			return view('Applicant_search/index',$param);
