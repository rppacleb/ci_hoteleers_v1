...
use App\Models\More_related_jobs_model;
use App\Models\Audit_trail_model;
use App\Libraries\Pcl_lib;
class More_related_jobs extends BaseController{
	protected $model;
	protected $session;
	...
	public function __construct(){
		...
		$this->model 			= new More_related_jobs_model();
    ...
    public function index($type){
			...
			return view('More_related_jobs/index',$param);
