...
use App\Models\Partner_application_model;
use App\Models\Audit_trail_model;
use App\Libraries\Pcl_lib;
class Partner_application extends BaseController{
	protected $model;
	protected $session;
	...
	public function __construct(){
		...
		$this->model 			= new Partner_application_model();
    ...
    public function index(){
		...
		if(!$this->session->has('username')){
			...
			return view('Partner_application/index',$param);
  		}//end if
