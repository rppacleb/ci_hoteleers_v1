...
use App\Models\Deactivated_jobs_model;
use App\Models\Audit_trail_model;
use App\Libraries\Pcl_lib;
class Deactivated_jobs extends BaseController{
	protected $model;
	protected $session;
	...
	public function __construct(){
		...
		$this->model 			= new Deactivated_jobs_model();
    ...
    public function index(){
			...
			return view('Deactivated_jobs/index',$param);
