...
use App\Models\Trending_jobs_model;
use App\Models\Audit_trail_model;
use App\Libraries\Pcl_lib;
class Trending_jobs extends BaseController{
	protected $model;
	protected $session;
	...
	public function __construct(){
		...
		$this->model 			= new Trending_jobs_model();
		$this->audit_trail 		= new Audit_trail_model();
		$this->record_type 		= 'trending_jobs';
    ...
    public function index(){
			...
			return view('Trending_jobs/index',$param);
