...
use App\Models\Company_info_public_vw_model;
use App\Models\Audit_trail_model;
use App\Libraries\Pcl_lib;
class Company_info_public_vw extends BaseController{
	protected $model;
	protected $session;
	...
	public function __construct(){
		...
		$this->model 			= new Company_info_public_vw_model();
    ...
    public function index($type,$id){
			...
			return view('Company_info_public_vw/index',$param);
    	...
    	$rules = [
            ...
            "header.contact_number" => [
                ...
                'errors' => [
	                ...
	                'mobileValidation' => 'Incorrect tel_no.',
	            ]
            ],
            "header.location" => [
                "label" => "location", 
