...
use App\Models\Applicant_application_model;
use App\Models\Audit_trail_model;
use App\Libraries\Pcl_lib;
class Applicant_application extends BaseController{
	protected $model;
	protected $session;
	...
	public function __construct(){
		...
		$this->model 			= new Applicant_application_model();
		$this->audit_trail 		= new Audit_trail_model();
		$this->record_type 		= 'applicant_application';
    ...
    public function index(){
		...
		if(!$this->session->has('username')){
			...
			return view('Applicant_application/index',$param);
  		}//end if
