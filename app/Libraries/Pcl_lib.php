						 ...
						 <tbody>
							 ...
							 <td class="main-content" style="padding: 48px 30px 40px; color: #000000;" bgcolor="#ffffff">
								 ...
								 <tbody>
									 ...
									 <tr>
									 <td style="padding: 0 0 10px 0; font-size: 14px; line-height: 150%; font-weight: 400; color: #000000; letter-spacing: 0.01em;">
									 You`re receiving this email because you recently requested to reset the password for your Hoteleers account.                     </td>
									 </tr>
									 <tr>
									 <td style="padding: 0 0 10px 0; font-size: 14px; line-height: 150%; font-weight: 400; color: #000000; letter-spacing: 0.01em;">
									 Click the button below to proceed:      </td>
									 </tr>
									 <tr>
									 <td style="padding: 0 0 24px 0;">
										 <a class="button" href="'.$param["url_change_password"].'" title="Reset Password" style="width: 100%; background: #f4623a; text-decoration: none; display: inline-block; padding: 10px 0; color: #fff; font-size: 14px; line-height: 21px; text-align: center; font-weight: bold; border-radius: 7px;">Reset now</a>
									 </td>
									 </tr>
									 <tr>
									 <td style="padding: 0 0 24px 0;">
										 Wasn`t you? Please report this as a suspicious login and change your password immediately at <span style="color: #f4623a">admin@hoteleers.com</span>
									 </td>
									 </tr>
									 <tr>
									 <td>
						 ...
						 <tbody>
							 ...
							 <td class="main-content" style="padding: 48px 30px 40px; color: #000000;" bgcolor="#ffffff">
								 ...
								 <tbody>
									 ...
									 <tr>
									 <td style="padding: 0 0 24px 0;">
										 <a class="button" href="'.$param["url_reset"].'" title="Reset Password" style="width: 100%; background: #f4623a; text-decoration: none; display: inline-block; padding: 10px 0; color: #fff; font-size: 14px; line-height: 21px; text-align: center; font-weight: bold; border-radius: 7px;">Reset now</a>
									 </td>
									 </tr>
									 <tr>
									 <td style="padding: 0 0 24px 0;">
