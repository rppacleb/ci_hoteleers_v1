...
class Applicant_info_login_vw_model extends Model {
    ...
    function load_data($id){
            ...
            $qrystr     = "SELECT   t0.*,DATE_FORMAT(STR_TO_DATE(t0.start_date,'%m/%d/%Y'), '%b %d, %Y') AS 'start_date_placeholder',
                                    DATE_FORMAT(STR_TO_DATE(t0.end_date,'%m/%d/%Y'), '%b %d, %Y') AS 'end_date_placeholder'
            ...
            $qrystr     = "SELECT   t0.*,
                                    ...
                                    DATE_FORMAT(STR_TO_DATE(t0.start_date,'%m/%d/%Y'), '%b %d, %Y') AS 'start_date_placeholder',
                                    DATE_FORMAT(STR_TO_DATE(t0.end_date,'%m/%d/%Y'), '%b %d, %Y') AS 'end_date_placeholder'
