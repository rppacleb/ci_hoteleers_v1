...
class Applicant_info_vw_model extends Model {
    ...
    function load_data($id){
            ...
            $qrystr     = "SELECT   t0.*,
                            ...
                            WHERE t0.id = '$id'
                            ORDER BY t0.if_current DESC,STR_TO_DATE(t0.end_date,'%m/%d/%Y') DESC";
            $query      = $this->db->query($qrystr);
            if($query->getNumRows() > 0){
