...
var profile                     = <?php echo json_encode($profile["data"]) ?>;
...
<div class="row mb-5 mobile-jssearchrow">
	...
	<div class="col-xl-7 col-lg-7 col-md-12 col-xs-12 offset-xl-0 offset-lg-0 notification-target">
...
<div class="row mobile-jsjobsrow">
	...
	<div class="col-xl-9 col-lg-9 col-md-12 col-xs-12 offset-xl-0 offset-lg-0 tablet-jobsrow">
		...
		<div id="main_loader" class="row justify-content-center mb-3">
        ...
        <div class="row">
            <div class="col text-right">
                <?php if(isset($_SESSION['userid'])){?>
                    <!-- <a id="more_job_related" href="<?php echo base_url('more_related_jobs/'.$_SESSION['userid'].'') ?>" class="text-primary d-none">More job related to your field</a> -->
                <?php } ?>
            </div>
        </div><!--./row--> 
        <br/>
...
<script src="<?php echo base_url('assets/main/js/job_search.js?v='). date('Ymdi') ?>"></script>
