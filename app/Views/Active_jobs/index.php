...
<div class="row mb-3">
    <div class="col-xl-2 col-lg-2 col-md-3 col-sm-6 col-xs-12 aj-countercol" style="min-width:1.75in;">
        <div class="card mb-3"  style="opacity:0.8;background-color:rgb(0, 41, 170);">
          <div class="card-body">
            ...
            <h6 class="card-title text-muted" style="color:white !important;">JOB POSTS</h6>
            <a href="<?php echo base_url('active_jobs') ?>" style="text-decoration:none;">
                <h3 id="jobpost_counter" class="card-text text-left text-primary aj-counter" style="color:white !important;">
        ...
        <div class="card mb-3">
          <div class="card-body">
            ...
            <a href="<?php echo base_url('all_jobs_applicant') ?>" style="text-decoration:none;">
                <h3 id="applicant_counter" class="card-text text-left text-primary aj-counter"><?php echo $applicant_ctr?></h3>
            </a>
          </div>
        </div>
    </div>
        ...
        <div class="card mb-3">
          <div class="card-body">
            ...
            <a href="<?php echo base_url('all_jobs_applicant?view_type=short_listed') ?>" style="text-decoration:none;">
                <h3 id="short_listed_counter" class="card-text text-left text-primary aj-counter"><?php echo $applicant_short_listed_ctr?></h3>
            </a>
          </div>
        </div>
    </div>
        ...
        <div class="card mb-3">
          <div class="card-body">
            ...
            <a href="<?php echo base_url('all_jobs_applicant?view_type=interviews') ?>" style="text-decoration:none;">
                    <h3 id="interviews_counter" class="card-text text-left text-primary aj-counter"><?php echo $applicant_for_interview_ctr?></h3>
            </a>
          </div>
        </div>
    </div>
        ...
        <div class="card mb-3">
          <div class="card-body">
            ...
            <a href="<?php echo base_url('all_jobs_applicant?view_type=offered') ?>" style="text-decoration:none;">
                <h3 id="offered_counter" class="card-text text-left text-primary aj-counter"><?php echo $applicant_offered_ctr?></h3>
            </a>
          </div>
        </div>
    </div>
        ...
        <div class="row mb-2">
          <div class="col">
            <div class="card" style="border: 1px solid rgba(0, 0, 0, 0);">
              <div class="card-body aj-tablecontent">
                <div class="row">
                  <div class="col-1 text-center text-muted-header" style="min-width:0.5in;">
                    ID
                  </div><!--./col-->

                  <div class="col-2 text-left text-muted-header" style="min-width:1in;">
                    TITLE
                  </div><!--./col-->

                  <div class="col-2 text-left text-muted-header">
                    EXP. DATE
                  </div><!--./col-->
...
<script src="<?php echo base_url('assets/main/js/active_jobs.js?v='). date('Ymdi') ?>"></script>
