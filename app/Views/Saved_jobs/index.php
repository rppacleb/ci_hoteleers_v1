...
<div class="row mt-0 mb-3">
	...
	<div class="col-xl-2 col-lg-2 col-md-1 col-xs-1 col-1 offset-xl-0 offset-lg-0 tablet-tjspacer">
	</div><!--./col-->
	<div class="col-xl-9 col-lg-9 col-md-3 col-xs-3 col-4 offset-xl-0 offset-lg-0">
		<h4>Saved Jobs</h4>
	</div><!--./col-->
</div><!--./row-->
...
<script src="<?php echo base_url('assets/main/js/saved_jobs.js?v='). date('Ymdi') ?>"></script>
