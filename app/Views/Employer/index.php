...
<div class="row mb-5">
	<div class="col-xl-6 col-lg-6">
		<h4>Manage Employer(s)</h4>
	</div><!--./col-->
	<div class="col-xl-6 col-lg-6">
		<div class="text-right">
			<a href="<?php echo base_url('employer/add/0') ?>" class="btn btn-pill-sm btn-pill-sm-outline-light text-primary btn_add_append"><i class="fa fa-plus-circle" aria-hidden="true"></i> Add Employer</a>	
		</div><!--./text-right-->
	</div><!--./col-->
...
<div class="row mb-2">
	...
	<div class="text-center col-xl-2 col-lg-2 col-md-12 col-sm-12 col-xs-12 text-muted" style="min-width:3in;">
...
<script src="<?php echo base_url('assets/main/js/employer.js?v='). date('Ymdi') ?>"></script>
