...
<div class="row mb-5">
	<div class="col-xl-6 col-lg-6">
		<h4>Manage Partner Applications</h4>
	</div><!--./col-->
	<div class="col-xl-6 col-lg-6">
		<div class="text-right">
			<a href="<?php echo base_url('signup/') ?>" class="btn btn-pill-sm btn-pill-sm-outline-light text-primary btn_add_append" aria-type="education"><i class="fa fa-plus-circle" aria-hidden="true"></i> Add Partner</a>	
		</div><!--./text-right-->
	</div><!--./col-->
...
<div class="row mb-3">
	<div class="col">
		<p class="text-muted pagination_result"></p>
	</div><!--./col-->
...
<div class="row mb-2">
	...
	<div class="col text-center text-muted-header align-self-center" style="min-width:3.1in;">
	</div><!--./col-->
...
<script src="<?php echo base_url('assets/main/js/partner_application.js?v='). date('Ymdi') ?>"></script>
