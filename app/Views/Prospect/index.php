		...
		<div class="card" style="border: 1px solid rgba(0, 0, 0, 0);">
			<div class="card-body" style="padding: 0rem 1rem;">
				<div class="row">
					...
					<div class="text-muted-header text-center col-xl-2 col-lg-2 col-md-12 col-sm-12 col-xs-12 align-self-center" style="min-width:1in;">
						ACTION
					</div><!--./col-->
				</div>
			</div>
...
<div class="row">
    ...
    <div class="col">
        <nav>
            <ul class="pagination prospect_pagination justify-content-start" aria-type="prospect">
...
<script src="<?php echo base_url('assets/main/js/prospect.js?v='). date('Ymdi') ?>"></script>
