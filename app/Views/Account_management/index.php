...
<div id="prospect_loader" class="row row-cols-2">
</div>
...
<div id="prospect_container">
</div>

<div class="row">
	<div class="col">
		<p class="text-right"><a href="<?php echo base_url('prospect') ?>" class="text-link">View all Prospects</a></p>
	</div><!--./col-->
</div>
...
<div class="row">
	<div class="col">
		<p class="text-right"><a href="<?php echo base_url('active') ?>" class="text-link">View all Active</a></p>
	</div><!--./col-->
</div>
...
<div class="row">
	<div class="col">
		<p class="text-right"><a href="<?php echo base_url('inactive') ?>" class="text-link">View all Inactive</a></p>
	</div><!--./col-->
</div>
...
<div id="paused_loader" class="row row-cols-2">
</div>
...
<div id="paused_container">
</div>

<div class="row">
	<div class="col">
		<p class="text-right"><a href="<?php echo base_url('paused') ?>" class="text-link">View all Paused</a></p>
	</div><!--./col-->
</div>
...
<script src="<?php echo base_url('assets/main/js/account_management.js?v='). date('Ymdi') ?>"></script>
