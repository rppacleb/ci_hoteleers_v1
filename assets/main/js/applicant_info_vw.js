...
$(document).ready(function(){
    ...
    if(type == "view") {
        ...
        $('.desktop-aivwmobilenumber .aivw-mobcode').removeClass('col-lg-2 col-xl-2');
   ...
   //alert(moment('4/30/2016', 'MM/DD/YYYY').add(1, 'day'));
    ...
    $(document.body).on('click','#change_email',function(){
        const confirm_var = confirm('This will send a verification code to reset your email address!');
        var btn = $(this);
        // var btn_default_html = '<img width="30%" src="../../assets/img/main/change_email.svg">';
        var btn_default_html = '<i class="fa fa-pencil-square" aria-hidden="true" style="font-size: 20px;"></i>';
        var btn_loading_html = '<span class="spinner-grow spinner-grow-sm" role="status" aria-hidden="true"></span>';
    ...
    */
    ...
    var exp_lineVal = catchIsNaN($('input[name=row_experience\\[line\\]\\[\\]]:last').val()) + 1;
    ...
    $(document.body).on('click','button[name=btn_add_certification]',function(e){
        ...
        $('input[name=row_certification\\[expiration_date\\]\\[\\]]').datetimepicker({
            format: 'M/YYYY'
        });
    })
    ...
    $(document.body).on('change','input[id*=if_current]',function(e){
        ...
        container.find('input[name=row_education\\[end_date\\]\\[\\]], input[name=row_experience\\[end_date\\]\\[\\]]').parent().parent().removeClass('d-none');
        container.find('input[name=row_education\\[end_date\\]\\[\\]], input[name=row_experience\\[end_date\\]\\[\\]]').parent().parent().prev('label').removeClass('d-none');
        ...
        if($(this).is(":checked")){
            ...
            var div = container.parent().find('input[name=row_education\\[end_date\\]\\[\\]], input[name=row_experience\\[end_date\\]\\[\\]]');
            var div2 = div.parent().parent();
                div2.addClass('d-none');
    ...
    $(document.body).on('change','input[name*=no_expiration]',function(e){
        ...
        var container = $(this).parent().parent();
        container.find('input[name=row_certification\\[expiration_date\\]\\[\\]]').parent().parent().removeClass('d-none');
        container.find('input[name=row_certification\\[expiration_date\\]\\[\\]]').parent().parent().prev('label').removeClass('d-none');


        if(is_checked){
            var div = container.parent().find('input[name=row_certification\\[expiration_date\\]\\[\\]]');
            var div2 = div.parent().parent();
                div2.addClass('d-none');
            ...
            if(response.data !== null && response.data !== undefined){
                ...
                if(param.mode == 'edit' || param.mode == 'view'){
                    ...
                    //----------------------------------------------------------------------------------------------------
                        ...
                        if ($(window).width() <= 1024) {
                            html += '<div class="form-group row" style="margin-left: auto; margin-right: auto;">';
                                html += '<div class="col-8 col-sm-8 col-md-8 col-lg-7 col-xl-7 align-self-center">';
                                    html += data.resume;
                                html += '</div><!--./col-10-->';
                        ...
                        if(data.dial_code !== ''){
                            $('#frm_data_entry select[name=header\\[dial_code\\]]').multiselect('select',data.dial_code);
                        }else{
                        ...
                        $('#frm_data_entry input[name=placeholder\\[dial_code\\]]').val(data.dial_code);
                        ...
                        autosize($('#frm_data_entry textarea[name=header\\[highlights\\]]'));
                        ...
                        for(var key in data_lines){
                            ...
                            html += '<div class="card mb-2">';
                                ...
                                html += '<div class="form-group row d-none">';
                                    html += '<label class="col-3 col-form-label text-right align-self-center">Line <span class="text-danger fw-bolder">*</span></label>';
                                    html += '<div class="col-8 align-self-center">';
                                ...
                                html += '<div class="form-group row">';
                                    html += '<label class="col-4 col-sm-4 col-md-4 col-lg-3 col-xl-3 col-form-label text-right align-self-center">Job Title <span class="text-danger fw-bolder aivw-asterisk">*</span></label>';
                                    html += '<div class="col-8 col-sm-8 col-md-6 col-lg-8 col-xl-8 align-self-center">';
                                ...
                                html += '<div class="form-group row">';
                                if ($(window).width() <= 1024) {
                                    html += '<label class="col-4 col-sm-4 col-md-4 col-lg-3 col-xl-3 col-form-label text-right align-self-center">Company <br/> Name <span class="text-danger fw-bolder aivw-asterisk">*</span></label>';
                                } else {
                                    html += '<label class="col-4 col-sm-4 col-md-4 col-lg-3 col-xl-3 col-form-label text-right align-self-center">Company Name <span class="text-danger fw-bolder aivw-asterisk">*</span></label>';
                                }
                                    html += '<div class="col-8 col-sm-8 col-md-6 col-lg-8 col-xl-8 align-self-center">';
                                ...
                                html += '<div class="form-group row">';
                                    html += '<label class="col-4 col-sm-4 col-md-4 col-lg-3 col-xl-3 col-form-label text-right">Short description</label>';
                                    html += '<div class="col-8 col-sm-8 col-md-6 col-lg-8 col-xl-8">';
                                        html += '<textarea rows="10" class="form-control form-control-sm aivw-textarea" name="row_experience[short_description][]" maxlength="600">'+data_lines[key]['short_description']+'</textarea>';
                                    html += '</div><!--./col-10-->';
                                html += '</div><!--./form-group-->';
                                ...
                                if ($(window).width() <= 1024) {
                                    if(param.mode == 'view') {
                                        if(data_lines[key]['if_current'] == 0){
                                            html += '<div class="form-group row">';
                                                html += '<label class="col-4 col-sm-4 col-md-4 col-lg-3 col-xl-3 col-form-label text-right align-self-center">Start Date</label>';
                                                html += '<div class="col-8 col-sm-8 col-md-6 col-lg-8 col-xl-8 align-self-center">';
                                                    html += '<div class="input-group input-group-sm">';
                                                        ...
                                                        html += '<input placeholder="MM/YYYY" value="'+data_lines[key]['start_date']+'" class="form-control form-control-sm" type="text" name="row_experience[start_date][]"/>';
                                            ...
                                            html += '<div class="form-group row">';
                                                html += '<label class="col-4 col-sm-4 col-md-4 col-lg-3 col-xl-3 col-form-label text-right align-self-center">End Date</label>';
                                                html += '<div class="col-8 col-sm-8 col-md-6 col-lg-8 col-xl-8 align-self-center">';
                                                    html += '<div class="input-group input-group-sm date">';
                                                        ...
                                                        html += '<input placeholder="MM/YYYY" value="'+data_lines[key]['end_date']+'" class="form-control form-control-sm" type="text" name="row_experience[end_date][]"/>';
                                                        html += '<div class="input-group-append">';
                                                            html += '<span class="input-group-text"><i class="fa fa-calendar"></i></span>';
                                                        html += '</div><!--./input-group-append-->';
                                                    html += '</div><!--./input-group input-group-sm-->';
                                            ...
                                            html += '<div class="form-group row">';
                                                ...
                                                html += '<div class="col-8 col-sm-8 col-md-6 col-lg-8 col-xl-8 align-self-center">';
                                                    html += '<div class="input-group input-group-sm">';
                                                        html += '<input value="'+data_lines[key]['start_date_placeholder']+'&emsp;-&emsp;Present" class="form-control-sm d-none" type="text" name="placeholder[start_date][]"/>';
                                                        html += '<input placeholder="MM/YYYY" value="'+data_lines[key]['start_date']+'" class="form-control form-control-sm" type="text" name="row_experience[start_date][]"/>';
                                                        html += '<div class="input-group-append">';
                                                            html += '<span class="input-group-text"><i class="fa fa-calendar"></i></span>';
                                                        html += '</div><!--./input-group-append-->';
                                        ...
                                        html += '<div class="form-group row">';
                                            html += '<label class="col-4 col-sm-4 col-md-4 col-lg-3 col-xl-3 col-form-label text-right align-self-center" id="mob_edlabel'+key+'">End Date</label>';
                                            html += '<div class="col-8 col-sm-8 col-md-6 col-lg-8 col-xl-8 align-self-center" id="mob_edcol'+key+'">';
                                                html += '<div class="input-group input-group-sm date">';
                                                    html += '<input value="'+data_lines[key]['end_date_placeholder']+'" class="form-control-sm d-none" type="text" name="placeholder[end_date][]"/>';
                                                    html += '<input placeholder="MM/YYYY" value="'+data_lines[key]['end_date']+'" class="form-control form-control-sm" type="text" name="row_experience[end_date][]"/>';
                                                    html += '<div class="input-group-append">';
                                    ...
                                    if(param.mode == 'view') {
                                        if(data_lines[key]['if_current'] == 0){
                                            html += '<div class="form-group row">';
                                                html += '<label class="col-3 col-md-4 col-xl-3 col-lg-3 col-form-label text-right align-self-center">Start Date</label>';
                                            ...
                                            html += '<div class="form-group row">';
                                                html += '<label class="col-3 col-md-4 col-xl-3 col-lg-3 col-form-label text-right align-self-center">Start Date</label>';
                                                html += '<div class="col-2 align-self-center" style="width: 12.66666667%;">';
                                                    html += '<div class="input-group input-group-sm">';
                                                        html += '<input value="'+data_lines[key]['start_date_placeholder']+'" class="form-control-sm d-none" type="text" name="placeholder[start_date][]"/>';
                                                        html += '<input placeholder="MM/YYYY" value="'+data_lines[key]['start_date']+'" class="form-control form-control-sm" type="text" name="row_experience[start_date][]"/>';
                                                        html += '<div class="input-group-append">';
                                                ...
                                                html += '<div class="col-1 align-self-center" style="width: 5.33333333%">-';
                                                html += '</div><!--./col-->';
                                ...
                                html += '<div class="form-group row d-none">';
                                    html += '<label class="col-4 col-sm-4 col-md-4 col-lg-3 col-xl-3 col-form-label text-right align-self-center">If Current</label>';
                                    html += '<div class="col-1 align-self-center">';
                                        html += '<input value="'+data_lines[key]['if_current']+'" type="text" name="row_experience[if_current][]" id="row_experience_current'+key+'"/>';
                                    html += '</div><!--./col-10-->';
                                html += '</div><!--./form-group-->';
                    ...
                    if ($(window).width() >= 1025) {
                        ...
                        $('input:checkbox[id="row_experience[if_current][0]"]').change(function() {
                            if ($('#row_experience_current0').val() == 0) {
                                if($('#row_experience_current0').val() == 0 && $('#row_experience_current1').val() == 1){
                                    $('#edlabel0').addClass('d-none');
                                    $('#edcol0').addClass('d-none');
                                    $('#edlabel1').removeClass('d-none');
                                    $('#edcol1').removeClass('d-none');
                        ...
                        $('input:checkbox[id="row_experience[if_current][1]"]').change(function() {
                            if ($('#row_experience_current1').val() == 0) {
                                if($('#row_experience_current1').val() == 0 && $('#row_experience_current0').val() == 1){
                                    $('#edlabel1').addClass('d-none');
                                    $('#edcol1').addClass('d-none');
                                    $('#edlabel0').removeClass('d-none');
                                    $('#edcol0').removeClass('d-none');
                    ...
                    for(var key in data_lines){
                        html += '<div class="card mb-3">';
                            ...
                            html += '<div class="card-body aivw-skillscardbody">';
                                ...
                                html += '<div class="form-group row d-none">';
                                    html += '<label class="col-1 col-form-label text-right align-self-center">Line <span class="text-danger fw-bolder">*</span></label>';
                                    html += '<div class="col-8 align-self-center">';
                                ...
                                html += '<div class="form-group row aivw-skillsrow">';
                                    html += '<label class="col-1 col-form-label text-right align-self-center"><span class="text-danger fw-bolder aivw-asterisk">*</span></label>';
                                    html += '<div class="col-8 align-self-center">';
                    ...
                    for(var key in data_lines){
                        html += '<div class="card mb-2">';
                            ...
                            html += '<div class="card-body">';
                                ...
                                html += '<div class="form-group row d-none">';
                                    html += '<label class="col-4 col-sm-4 col-md-4 col-lg-3 col-xl-3 col-form-label text-right align-self-center">Line <span class="text-danger fw-bolder">*</span></label>';
                                    html += '<div class="col-8 col-sm-8 col-md-6 col-lg-8 col-xl-8 align-self-center">';
                                ...
                                if ($(window).width() <= 1024) {
                                    html += '<div class="form-group row">';
                                        html += '<label class="col-4 col-sm-4 col-md-4 col-lg-3 col-xl-3 col-form-label text-right align-self-center">University /<br/>School <span class="text-danger fw-bolder aivw-asterisk">*</span></label>';
                                        html += '<div class="col-8 col-sm-8 col-md-6 col-lg-8 col-xl-8 align-self-center">';
                                    ...
                                    html += '<div class="form-group row">';
                                        html += '<label class="col-4 col-sm-4 col-md-4 col-lg-3 col-xl-3 col-form-label text-right align-self-center">University/School <span class="text-danger fw-bolder aivw-asterisk">*</span></label>';
                                        html += '<div class="col-8 col-sm-8 col-md-6 col-lg-8 col-xl-8 align-self-center">';
                                            html += '<input value="'+data_lines[key]['school']+'" class="form-control form-control-sm" type="text" name="row_education[school][]" maxlength="200"/>';
                                        html += '</div><!--./col-10-->';
                                    html += '</div><!--./form-group-->';
                                ...
                                if ($(window).width() <= 1024) {
                                    html += '<div class="form-group row">';
                                        html += '<label class="col-4 col-sm-4 col-md-4 col-lg-3 col-xl-3 col-form-label text-right align-self-center">Degree/Field of Study <span class="text-danger fw-bolder aivw-asterisk">*</span></label>';
                                        html += '<div class="col-8 col-sm-8 col-md-6 col-lg-8 col-xl-8 align-self-center">';
                                ...
                                */
                                ...
                                html += '<div class="form-group row">';
                                    html += '<label class="col-4 col-sm-4 col-md-4 col-lg-3 col-xl-3 col-form-label text-right align-self-center">Education <span class="text-danger fw-bolder aivw-asterisk">*</span></label>';
                                    html += '<div class="col-8 col-sm-8 col-md-6 col-lg-8 col-xl-8 align-self-center">';
                                        html += '<div class="input-group input-group-sm aivw-withsel">';
                                            html += '<input value="'+data_lines[key]['education_text']+'" class="form-control form-control-sm d-none" type="text" name="placeholder[education][]"/>';
                                ...
                                if ($(window).width() <= 1024) {
                                    if(param.mode == 'view') {
                                        if(data_lines[key]['if_current'] == 0){
                                            html += '<div class="form-group row">';
                                                ...
                                                html += '<div class="col-8 col-sm-8 col-md-6 col-lg-8 col-xl-8 align-self-center">';
                                                    html += '<div class="input-group input-group-sm">';
                                                        html += '<input value="'+data_lines[key]['start_date_placeholder']+'" class="form-control-sm d-none" type="text" name="placeholder[start_date][]"/>';
                                                        html += '<input placeholder="MM/YYYY" value="'+data_lines[key]['start_date']+'" class="form-control form-control-sm" type="text" name="row_education[start_date][]"/>';
                                                        html += '<div class="input-group-append">';
                                                            html += '<span class="input-group-text"><i class="fa fa-calendar"></i></span>';
                                                        html += '</div><!--./input-group-append-->';
                                                    html += '</div><!--./input-group input-group-sm-->';
                                            ...
                                            html += '<div class="form-group row">';
                                                ...
                                                html += '<div class="col-8 col-sm-8 col-md-6 col-lg-8 col-xl-8 align-self-center">';
                                                    html += '<div class="input-group input-group-sm date">';
                                                        html += '<input value="'+data_lines[key]['end_date_placeholder']+'" class="form-control-sm d-none" type="text" name="placeholder[end_date][]"/>';
                                                        html += '<input placeholder="MM/YYYY" value="'+data_lines[key]['end_date']+'" class="form-control form-control-sm" type="text" name="row_education[end_date][]"/>';
                                                        html += '<div class="input-group-append">';
                                                            html += '<span class="input-group-text"><i class="fa fa-calendar"></i></span>';
                                                        html += '</div><!--./input-group-append-->';
                                                    html += '</div><!--./input-group input-group-sm-->';
                                        ...
                                        html += '<div class="form-group row">';
                                            html += '<label class="col-4 col-sm-4 col-md-4 col-lg-3 col-xl-3 col-form-label text-right align-self-center" id="mob_ed_educationlabel'+key+'">End Date</label>';
                                            html += '<div class="col-8 col-sm-8 col-md-6 col-lg-8 col-xl-8 align-self-center" id="mob_ed_educationcol'+key+'">';
                                                html += '<div class="input-group input-group-sm date">';
                                                    html += '<input value="'+data_lines[key]['end_date_placeholder']+'" class="form-control-sm d-none" type="text" name="placeholder[end_date][]"/>';
                                                    html += '<input placeholder="MM/YYYY" value="'+data_lines[key]['end_date']+'" class="form-control form-control-sm" type="text" name="row_education[end_date][]"/>';
                                                    html += '<div class="input-group-append">';
                                    ...
                                    if(param.mode == 'view') {
                                        if(data_lines[key]['if_current'] == 0){
                                            ...
                                            html += '<div class="form-group row">';
                                                html += '<label class="col-3 col-md-4 col-xl-3 col-lg-3 col-form-label text-right align-self-center">Start Date</label>';
                                                html += '<div class="col-3 align-self-center" style="width: 12.66666667%;">';
                                                    html += '<div class="input-group input-group-sm">';
                                                        html += '<input value="'+data_lines[key]['start_date_placeholder']+'" class="form-control-sm d-none" type="text" name="placeholder[start_date][]"/>';
                                                        html += '<input placeholder="MM/YYYY" value="'+data_lines[key]['start_date']+'" class="form-control form-control-sm" type="text" name="row_education[start_date][]"/>';
                                                        html += '<div class="input-group-append">';
                                ...
                                html += '<div class="form-group row d-none">';
                                    ...
                                    html += '<div class="col-1 align-self-center">';
                                        ...
                                        html += '<input value="'+data_lines[key]['if_current']+'" type="text" name="row_education[if_current][]" id="row_education_current'+key+'"/>';
                                    html += '</div><!--./col-10-->';
                                html += '</div><!--./form-group-->';
                    ...
                    if ($(window).width() >= 1025) {
                        ...
                        $('input:checkbox[id="row_education[if_current][edu_0]"]').change(function() {
                            if ($('#row_education_current0').val() == 0) {
                                if ($('#row_education_current0').val() == 0 && $('#row_education_current1').val() == 1) {
                                    $('#ed_educationlabel0').addClass('d-none');
                                    $('#ed_educationcol0').addClass('d-none');
                                    $('#ed_educationlabel1').removeClass('d-none');
                                    $('#ed_educationcol1').removeClass('d-none');
                        ...
                        $('input:checkbox[id="row_education[if_current][edu_1]"]').change(function() {
                            if ($('#row_education_current1').val() == 0) {
                                if ($('#row_education_current1').val() == 0 && $('#row_education_current0').val() == 1) {
                                    $('#ed_educationlabel1').addClass('d-none');
                                    $('#ed_educationcol1').addClass('d-none');
                                    $('#ed_educationlabel0').removeClass('d-none');
                                    $('#ed_educationcol0').removeClass('d-none');
                    ...
                    for(var key in data_lines){
                        $('select[name=row_education\\[education\\]\\[\\]]').eq(key).multiselect('select',data_lines[key]['education'])
                    }//end if
                    //end education
                    ...
                    for(var key in data_lines){
                        html += '<div class="card mb-3">';
                            ...
                            html += '<div class="card-body aivw-skillscardbody">';
                                ...
                                html += '<div class="form-group row">';
                                    html += '<label class="col-lg-3 col-xl-3 col-auto col-form-label text-right align-self-center">Certification & License<span class="text-danger fw-bolder">*</span></label>';
                                ...
                                html += '<div class="form-group row">';
                                    html += '<label class="col-lg-3 col-xl-3 col-auto col-form-label text-right align-self-center">Issued Date <span class="text-danger fw-bolder">*</span></label>';
                                    html += '<div class="col-lg-3 col-xl-3 col-auto align-self-center">';
                                        html += '<div class="input-group input-group-sm">';
                                            html += '<input value="'+data_lines[key]['issued_date']+'" placeholder="M/YYYY" class="form-control form-control-sm" type="text" name="row_certification[issued_date][]"/>';
                                            html += '<div class="input-group-append">';
                                                html += '<span class="input-group-text"><i class="fa fa-calendar"></i></span>';
                                            html += '</div><!--./input-group-append-->';
                                        html += '</div><!--./input-group input-group-sm-->';
                                    ...
                                    html += '<label class="'+show_end_date+' col-lg-2 col-xl-2 col-auto col-form-label text-right align-self-center">Exp. Date</label>';
                                    html += '<div class="'+show_end_date+' col-lg-3 col-xl-3 col-auto align-self-center">';
                                        html += '<div class="input-group input-group-sm date">';
                                            html += '<input value="'+data_lines[key]['expiration_date']+'" placeholder="M/YYYY" class="form-control form-control-sm" type="text" name="row_certification[expiration_date][]"/>';
                                            html += '<div class="input-group-append">';
                                                html += '<span class="input-group-text"><i class="fa fa-calendar"></i></span>';
                                            html += '</div><!--./input-group-append-->';
                                        html += '</div><!--./input-group input-group-sm-->';
                                ...
                                html += '<div class="form-group row">';
                                    html += '<label class="col-lg-3 col-xl-3 col-auto col-form-label text-right align-self-center">No Expiration</label>';
                                    html += '<div class="col-lg-3 col-xl-3 col-auto align-self-center">';
                                        html += '<input type="checkbox" '+is_check+' name="row_certification[no_expiration][]"/>';
                                    html += '</div><!--./col-10-->';
                                html += '</div><!--./form-group-->';
                    ...
                    for(var key in data_lines){
                        html += '<div>';
                            ...
                            html += '<div>';
                                ...
                                html += '<div class="form-group row">';
                                    html += '<label class="col-4 col-sm-4 col-md-4 col-lg-1 col-xl-1 col-form-label text-right align-self-center"></label>';
                                    html += '<div class="col-8 col-sm-8 col-md-6 col-lg-8 col-xl-8 align-self-center">';
                                        html += '<div class="input-group input-group-sm aivw-withsel">';
                                            html += '<input value="'+data_lines[key]['industry_text']+'" class="form-control form-control-sm d-none" type="text" name="placeholder[industry][]"/>';
                    ...
                    for(var key in data_lines){
                        $('select[name=row_industry\\[industry\\]\\[\\]]').eq(key).multiselect('select',data_lines[key]['industry'])
                    }//end if
                    //end industry
                        ...
                        html += '<div>';
                            ...
                            html += '<div>';
                                ...
                                html += '<div class="form-group row">';
                                    ...
                                    html += '<div class="col-8 col-sm-8 col-md-6 col-lg-8 col-xl-8 align-self-center">';
                                        html += '<div class="input-group input-group-sm aivw-withsel">';
                                            html += '<input value="'+data_lines[key]['job_level_text']+'" class="form-control form-control-sm d-none" type="text" name="placeholder[job_level][]"/>';
                    ...
                    for(var key in data_lines){
                        $('select[name=row_job_level\\[job_level\\]\\[\\]]').eq(key).multiselect('select',data_lines[key]['job_level'])
                    }//end if
                    //end job level
                        ...
                        html += '<div>';
                            ...
                            html += '<div>';
                                ...
                                html += '<div class="form-group row">';
                                    ...
                                    html += '<div class="col-8 col-sm-8 col-md-6 col-lg-8 col-xl-8 align-self-center">';
                                        html += '<div class="input-group input-group-sm aivw-withsel">';
                                            html += '<input value="'+data_lines[key]['job_type_text']+'" class="form-control form-control-sm d-none" type="text" name="placeholder[job_type][]"/>';
                    ...
                    for(var key in data_lines){
                        $('select[name=row_job_type\\[job_type\\]\\[\\]]').eq(key).multiselect('select',data_lines[key]['job_type'])
                    }//end if
                    //end job type
                    ...
                    for(var key in data_lines){
                        html += '<div>';
                            ...
                            html += '<div>';
                                ...
                                html += '<div class="form-group row">';
                                    html += '<label class="col-4 col-sm-4 col-md-4 col-lg-1 col-xl-1 col-form-label text-right align-self-center"></label>';
                                    html += '<div class="col-8 col-sm-8 col-md-7 col-lg-8 col-xl-8 align-self-center">';
                                        html += '<div class="input-group input-group-sm aivw-withsel">';
                                            html += '<input value="'+data_lines[key]['department_text']+'" class="form-control form-control-sm d-none w-100" type="text" name="placeholder[department][]"/>';
                    ...
                    var url     = baseurl + "/get/job_post/odepartment";
                    var dropdown    = $('select[name=row_department\\[department\\]\\[\\]]');
                    load_dropdown(url,dropdown)
                    load_dropdowns(dropdown);

                    for(var key in data_lines){
                        $('select[name=row_department\\[department\\]\\[\\]]').eq(key).multiselect('select',data_lines[key]['department'])
                    }//end if
                    //end department
            ...
            $.ajax({
                ...
                if(data.success === true){
                    ...
                    setTimeout(function(){
                        ...
                        btn.html('<a class="btn btn-pill-sm-primary text-primary btn-sm upload-resumebtn" style="font-size: 1rem; padding: 1px 1px; width: 1.5in; border: 2px solid rgba(var(--bs-primary-rgb));">Upload Resume</a>');
            ...
            html += '<div class="card mb-2">';
                ...
                html += '<div class="card-body">';
                    ...
                    html += '<div class="form-group row d-none">';
                        html += '<label class="col-3 col-form-label text-right align-self-center">Line <span class="text-danger fw-bolder">*</span></label>';
                        html += '<div class="col-8 align-self-center">';
                            html += '<input readonly class="form-control form-control-sm" type="text" name="row_experience[line][]" id="exp_line['+i_expline+']" maxlength="100"/>';
                        html += '</div><!--./col-10-->';
                    html += '</div><!--./form-group-->';

                    html += '<div class="form-group row">';
                        html += '<label class="col-3 col-form-label text-right align-self-center">Job Title <span class="text-danger fw-bolder">*</span></label>';
                        html += '<div class="col-8 align-self-center">';
                    ...
                    html += '<div class="form-group row">';
                    if ($(window).width() <= 1024) {
                        html += '<label class="col-4 col-sm-4 col-md-4 col-lg-3 col-xl-3 col-form-label text-right align-self-center">Company <br/> Name <span class="text-danger fw-bolder">*</span></label>';
                    } else {
                        html += '<label class="col-4 col-sm-4 col-md-4 col-lg-3 col-xl-3 col-form-label text-right align-self-center">Company Name <span class="text-danger fw-bolder">*</span></label>';
                    }
                        html += '<div class="col-8 align-self-center">';
                    ...
                    html += '<div class="form-group row">';
                        html += '<label class="col-3 col-form-label text-right align-self-start">Short description</label>';
                        html += '<div class="col-8 align-self-center">';
                            html += '<textarea rows="10" class="form-control form-control-sm aivw-textarea" name="row_experience[short_description][]" maxlength="600"></textarea>';
                        html += '</div><!--./col-10-->';
                    html += '</div><!--./form-group-->';
                    ...
                    if ($(window).width() <= 1024) {
                        html += '<div class="form-group row">';
                            ...
                            html += '<div class="col-8 col-sm-8 col-md-6 col-lg-8 col-xl-8 align-self-center">';
                                html += '<div class="input-group input-group-sm">';
                                    html += '<input placeholder="MM/YYYY" class="form-control form-control-sm" type="text" value="'+todayStart+'" name="row_experience[start_date][]"/>';
                                    html += '<div class="input-group-append">';
                                        html += '<span class="input-group-text"><i class="fa fa-calendar"></i></span>';
                                    html += '</div><!--./input-group-append-->';
                                html += '</div><!--./input-group input-group-sm-->';
                        ...
                        html += '<div class="form-group row">';
                            ...
                            html += '<div class="col-8 col-sm-8 col-md-6 col-lg-8 col-xl-8 align-self-center">';
                                html += '<div class="input-group input-group-sm date">';
                                    html += '<input placeholder="MM/YYYY" class="form-control form-control-sm" type="text" value="'+todayEnd+'" name="row_experience[end_date][]"/>';
                                    html += '<div class="input-group-append">';
                                        html += '<span class="input-group-text"><i class="fa fa-calendar"></i></span>';
                                    html += '</div><!--./input-group-append-->';
                                html += '</div><!--./input-group input-group-sm-->';
                    ...
                    html += '<div class="form-group row">';
                        ...
                        html += '<div class="col-1 align-self-center">';
                            html += '<input type="checkbox" class="w-auto" value="false" id="row_experience[if_current][]"/>';
                        html += '</div><!--./col-10-->';
                    html += '</div><!--./form-group-->';
        ...
        var html = '';
            ...
            html += '<div class="card mb-2">';
                ...
                html += '<div class="card-body aivw-skillscardbody">';
                    ...
                    html += '<div class="form-group row aivw-skillsrow">';
                        html += '<label class="col-1 col-form-label text-right align-self-center"><span class="text-danger fw-bolder">*</span></label>';
                        html += '<div class="col-8 align-self-center">';
        ...
        var html = '';
            html += '<div class="card mb-2">';
                ...
                html += '<div class="card-body">';
                    ...
                    if ($(window).width() <= 1024) {
                        html += '<div class="form-group row">';
                            html += '<label class="col-4 col-sm-4 col-md-4 col-lg-3 col-xl-3 col-form-label text-right align-self-center">University /<br/>School <span class="text-danger fw-bolder">*</span></label>';
                            html += '<div class="col-8 col-sm-8 col-md-6 col-lg-8 col-xl-8 align-self-center">';
                        ...
                        html += '<div class="form-group row">';
                            html += '<label class="col-4 col-sm-4 col-md-4 col-lg-3 col-xl-3 col-form-label text-right align-self-center">Degree/Field of Study <span class="text-danger fw-bolder">*</span></label>';
                            html += '<div class="col-8 col-sm-8 col-md-6 col-lg-8 col-xl-8 align-self-center">';
                        ...
                        html += '<div class="form-group row">';
                            html += '<label class="col-4 col-sm-4 col-md-4 col-lg-3 col-xl-3 col-form-label text-right align-self-center">University/School <span class="text-danger fw-bolder">*</span></label>';
                            html += '<div class="col-8 col-sm-8 col-md-6 col-lg-8 col-xl-8 align-self-center">';
                                html += '<input class="form-control form-control-sm" type="text" name="row_education[school][]" maxlength="200"/>';
                            html += '</div><!--./col-10-->';
                        html += '</div><!--./form-group-->';
                    ...
                    html += '<div class="form-group row">';
                        html += '<label class="col-3 col-form-label text-right align-self-center">Education <span class="text-danger fw-bolder">*</span></label>';
                        html += '<div class="col-8 align-self-center">';
                            html += '<div class="input-group input-group-sm">';
                                html += '<input class="form-control form-control-sm d-none" type="text" name="placeholder[education][]"/>';
                                html += '<select name="row_education[education][]"></select>';
                            html += '</div>';
                        html += '</div><!--./col-10-->';
                    html += '</div><!--./form-group-->';
                    ...
                    if ($(window).width() <= 1024) {
                        html += '<div class="form-group row">';
                            ...
                            html += '<div class="col-8 col-sm-8 col-md-6 col-lg-8 col-xl-8 align-self-center">';
                                html += '<div class="input-group input-group-sm">';
                                    html += '<input placeholder="MM/YYYY" class="form-control form-control-sm" type="text" value="'+todayStart+'" name="row_education[start_date][]"/>';
                                    html += '<div class="input-group-append">';
                                        html += '<span class="input-group-text"><i class="fa fa-calendar"></i></span>';
                                    html += '</div><!--./input-group-append-->';
                                html += '</div><!--./input-group input-group-sm-->';
                        ...
                        html += '<div class="form-group row">';
                            ...
                            html += '<div class="col-8 col-sm-8 col-md-6 col-lg-8 col-xl-8 align-self-center">';
                                html += '<div class="input-group input-group-sm date">';
                                    html += '<input placeholder="MM/YYYY" class="form-control form-control-sm" type="text" value="'+todayEnd+'" name="row_education[end_date][]"/>';
                                    html += '<div class="input-group-append">';
                                        html += '<span class="input-group-text"><i class="fa fa-calendar"></i></span>';
                                    html += '</div><!--./input-group-append-->';
                                html += '</div><!--./input-group input-group-sm-->';
            ...
            html += '<div class="card mb-2">';
                ...
                html += '<div class="card-body aivw-skillscardbody">';
                    ...
                    html += '<div class="form-group row">';
                        ...
                        html += '<div class="col-lg-3 col-xl-3 col-auto align-self-center">';
                            html += '<div class="input-group input-group-sm">';
                                html += '<input placeholder="M/YYYY" class="form-control form-control-sm" type="text" name="row_certification[issued_date][]"/>';
                                html += '<div class="input-group-append">';
                                    html += '<span class="input-group-text"><i class="fa fa-calendar"></i></span>';
                                html += '</div><!--./input-group-append-->';
                            html += '</div><!--./input-group input-group-sm-->';
                        ...
                        html += '<div class="col-lg-3 col-xl-3 col-auto align-self-center">';
                            html += '<div class="input-group input-group-sm date">';
                                html += '<input placeholder="M/YYYY" class="form-control form-control-sm" type="text" name="row_certification[expiration_date][]"/>';
                                html += '<div class="input-group-append">';
                                    html += '<span class="input-group-text"><i class="fa fa-calendar"></i></span>';
                                html += '</div><!--./input-group-append-->';
                            html += '</div><!--./input-group input-group-sm-->';
                    ...
                    html += '<div class="form-group row">';
                        html += '<label class="col-lg-3 col-xl-3 col-auto col-form-label text-right align-self-center">No Expiration</label>';
                        html += '<div class="col-lg-3 col-xl-3 col-auto align-self-center">';
                            html += '<input type="checkbox" name="row_certification[no_expiration][]"/>';
                        html += '</div><!--./col-10-->';
                    html += '</div><!--./form-group-->';
            ...
            html += '<div>';
                ...
                html += '<div>';
                    ...
                    html += '<div class="form-group row">';
                        ...
                        html += '<div class="col-8 align-self-center">';
                            html += '<div class="input-group input-group-sm">';
                                html += '<input class="form-control form-control-sm d-none" type="text" name="placeholder[industry][]"/>';
                                html += '<select name="row_industry[industry][]"></select>';
                            html += '</div>';
                        html += '</div><!--./col-10-->';
                    html += '</div><!--./form-group-->';
            ...
            html += '<div>';
                ...
                html += '<div>';
                    ...
                    html += '<div class="form-group row">';
                        ...
                        html += '<div class="col-8 align-self-center">';
                            html += '<div class="input-group input-group-sm">';
                                html += '<input class="form-control form-control-sm d-none" type="text" name="placeholder[job_level][]"/>';
                                html += '<select name="row_job_level[job_level][]"></select>';
                            html += '</div>';
                        html += '</div><!--./col-10-->';
                    html += '</div><!--./form-group-->';
            ...
            html += '<div>';
                ...
                html += '<div>';
                    ...
                    html += '<div class="form-group row">';
                        ...
                        html += '<div class="col-8 align-self-center">';
                            html += '<div class="input-group input-group-sm">';
                                html += '<input class="form-control form-control-sm d-none" type="text" name="placeholder[job_type][]"/>';
                                html += '<select name="row_job_type[job_type][]"></select>';
                            html += '</div>';
                        html += '</div><!--./col-10-->';
                    html += '</div><!--./form-group-->';
            ...
            html += '<div>';
                ...
                html += '<div>';
                    ...
                    html += '<div class="form-group row">';
                        ...
                        html += '<div class="col-8 align-self-center">';
                            html += '<div class="input-group input-group-sm">';
                                html += '<input class="form-control form-control-sm d-none" type="text" name="placeholder[department][]"/>';
                                html += '<select name="row_department[department][]"></select>';
                            html += '</div>';
                        html += '</div><!--./col-10-->';
                    html += '</div><!--./form-group-->';
