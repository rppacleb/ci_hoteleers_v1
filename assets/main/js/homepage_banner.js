...
$(document).ready(function(){
    ...
    $('#side_homepage_banner').css({'opacity': 0.8, "background-color": "rgb(0, 41, 170)"});
    //end highlight
            ...
            $.ajax({
                ...
                if(data.success === true){
                    ...
                    setTimeout(function(){
                        ...
                        $('img[id=header\\[banner_a\\]]').attr('src',"data:image/jpeg;base64, "+file.file);
            ...
            $.ajax({
                ...
                if(data.success === true){
                    ...
                    setTimeout(function(){
                        ...
                        $('img[id=header\\[banner_b\\]]').attr('src',"data:image/jpeg;base64, "+file.file);
            ...
            $.ajax({
                ...
                if(data.success === true){
                    ...
                    setTimeout(function(){
                        ...
                        $('img[id=header\\[banner_c\\]]').attr('src',"data:image/jpeg;base64, "+file.file);
            ...
            $.ajax({
                ...
                if(data.success === true){
                    ...
                    setTimeout(function(){
                        ...
                        $('img[id=header\\[banner_d\\]]').attr('src',"data:image/jpeg;base64, "+file.file);
        ...
        $.ajax({
            ...
            if(response.data !== null){
                ...
                if(param.mode == 'edit' || param.mode == 'view'){
                    ...
                    //view and edit mode
                    //----------------------------------------------------------------------------------------------------
                    $('#frm_data_entry input[name=header\\[doc_image_a\\]]').val(data.doc_image_a);
                    $('#frm_data_entry input[name=file\\[old_doc_image_a\\]]').val(data.doc_image_a);
                    
                    $('#frm_data_entry input[name=header\\[doc_image_b\\]]').val(data.doc_image_b);
                    $('#frm_data_entry input[name=file\\[old_doc_image_b\\]]').val(data.doc_image_b);

                    $('#frm_data_entry input[name=header\\[doc_image_c\\]]').val(data.doc_image_c);
                    $('#frm_data_entry input[name=file\\[old_doc_image_c\\]]').val(data.doc_image_c);

                    $('#frm_data_entry input[name=header\\[doc_image_d\\]]').val(data.doc_image_d);
                    $('#frm_data_entry input[name=file\\[old_doc_image_d\\]]').val(data.doc_image_d);

                    $('#frm_data_entry input[name=header\\[title_a\\]]').val(data.title_a);
                    $('#frm_data_entry textarea[name=header\\[description_a\\]]').val(data.description_a);


                    $('#frm_data_entry input[name=header\\[title_b\\]]').val(data.title_b);
                    $('#frm_data_entry textarea[name=header\\[description_b\\]]').val(data.description_b);

                    $('#frm_data_entry input[name=header\\[title_c\\]]').val(data.title_c);
                    $('#frm_data_entry textarea[name=header\\[description_c\\]]').val(data.description_c);

                    $('#frm_data_entry input[name=header\\[title_d\\]]').val(data.title_d);
                    $('#frm_data_entry textarea[name=header\\[description_d\\]]').val(data.description_d);

                   

                    if(param.mode == 'view'){
                        const about_us_desc         = load_text_editor($('#frm_data_entry textarea[name=header\\[about_us_desc\\]]'),false);
                        const contact_us_content_1  = load_text_editor($('#frm_data_entry textarea[name=header\\[contact_us_content_1\\]]'),false);
                        const contact_us_content_2  = load_text_editor($('#frm_data_entry textarea[name=header\\[contact_us_content_2\\]]'),false);
                        const contact_us_content_3  = load_text_editor($('#frm_data_entry textarea[name=header\\[contact_us_content_3\\]]'),false);
                        const contact_us_content_4  = load_text_editor($('#frm_data_entry textarea[name=header\\[contact_us_content_4\\]]'),false);
                        const contact_us_content_5  = load_text_editor($('#frm_data_entry textarea[name=header\\[contact_us_content_5\\]]'),false);
                        const terms_of_use         = load_text_editor($('#frm_data_entry textarea[name=header\\[terms_of_use\\]]'),false);
                        const privacy_policy         = load_text_editor($('#frm_data_entry textarea[name=header\\[privacy_policy\\]]'),false);
                        ...
                        const about_us_desc         = load_text_editor($('#frm_data_entry textarea[name=header\\[about_us_desc\\]]'),true);
                        const contact_us_content_1  = load_text_editor($('#frm_data_entry textarea[name=header\\[contact_us_content_1\\]]'),true);
                        const contact_us_content_2  = load_text_editor($('#frm_data_entry textarea[name=header\\[contact_us_content_2\\]]'),true);
                        const contact_us_content_3  = load_text_editor($('#frm_data_entry textarea[name=header\\[contact_us_content_3\\]]'),true);
                        const contact_us_content_4  = load_text_editor($('#frm_data_entry textarea[name=header\\[contact_us_content_4\\]]'),true);
                        const contact_us_content_5  = load_text_editor($('#frm_data_entry textarea[name=header\\[contact_us_content_5\\]]'),true);
                        const terms_of_use         = load_text_editor($('#frm_data_entry textarea[name=header\\[terms_of_use\\]]'),true);
                        const privacy_policy         = load_text_editor($('#frm_data_entry textarea[name=header\\[privacy_policy\\]]'),true);
                    ...
                    if(data.doc_image_a === null || data.doc_image_a == ""){
                        ...
                        $('img[id=header\\[banner_a\\]]').attr('src',upload_path+data.doc_image_a);
                    }//end if

                    if(data.doc_image_b === null || data.doc_image_b == ""){
                        $('img[id=header\\[banner_b\\]]').attr('src',urlimgdef);
                    }else{
                        $('img[id=header\\[banner_b\\]]').attr('src',upload_path+data.doc_image_b);
                    }//end if

                    if(data.doc_image_c === null || data.doc_image_c == ""){
                        $('img[id=header\\[banner_c\\]]').attr('src',urlimgdef);
                    }else{
                        $('img[id=header\\[banner_c\\]]').attr('src',upload_path+data.doc_image_c);
                    ...
                    if(data.doc_image_d === null || data.doc_image_d == ""){
                        ...
                        $('img[id=header\\[banner_d\\]]').attr('src',upload_path+data.doc_image_d);
                    }//end if
                ...
                if(param.mode == 'view'){
                    $('#frm_data_entry input,textarea:not([readonly]),select,button').addClass(param.mode);
