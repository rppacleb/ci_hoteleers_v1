$(document).ready(function () {
  ...
  $(".step").on("click", function () {
    ...
    if (
      ...
      selectedValue !== "" &&
      selectedValue !== "for interview"
    ) {
      var notification =
        "Are you sure you want to move this record to " + selectedValue + "?";
      if (selectedValue === "short listed") {
      ...
      if (!w_interview["success"]) {
        if (
          confirm(
            "You'll be redirected to the Schedule Interview page. Click OK to proceed."
          )
        ) {
          var interview_url =
            baseurl +
            "/schedule/add/0?user_id=" +
            user +
            "&job_post=" +
            job_post_id +
            "";
        ...
        var msg_html =
          "There's already an ongoing interview for this applicant. Please wait for the interview to finish to schedule a new one!";
        $.notify(msg_html, {
          position: "top center",
          className: "error",
          arrowShow: true,
  ...
  function load_data(param) {
    ...
    var btn = $(".btn_submit");
    var btn_text = "Submit";
    var compare_with_url =
      baseurl +
      "/compare_applicant?job_post=" +
      job_post_id +
      "&user_id=" +
      param.id +
      "&employer_id=" +
          ...
          if (data !== undefined) {
            if (param.mode == "edit" || param.mode == "view") {
              ...
              for (var key in data_lines) {
                ...
                html +=
                  '<label class="col-3 col-form-label text-right align-self-center">Line</label>';
                ...
                html +=
                  '<label class="col-3 col-form-label text-right align-self-center">Position</label>';
                html += '<div class="col align-self-center">';
                html +=
                  '<input value="' +
                ...
                html += '<div class="form-group row">';
                html +=
                  '<label class="col-3 col-form-label text-right align-self-center">Company Name</label>';
                html += '<div class="col align-self-center">';
                html +=
                  '<input value="' +
                ...
                html += '<div class="form-group row">';
                html +=
                  '<label class="col-3 col-form-label text-right align-self-center">Short description</label>';
                html += '<div class="col align-self-center">';
                html +=
                  '<textarea class="form-control form-control-sm asvw-textarea" name="row_experience[short_description][]">' +
              ...
              for (var key in data_lines) {
                ...
                html += '<div class="form-group row">';
                html +=
                  '<label class="col-3 col-form-label text-right align-self-center">University/School</label>';
                html += '<div class="col align-self-center">';
                html +=
                  '<input value="' +
                ...
                html += '<div class="form-group row">';
                html +=
                  '<label class="col-3 col-form-label text-right align-self-center">Degree/Field of Study</label>';
                html += '<div class="col align-self-center">';
                html +=
                  '<input value="' +
                ...
                html += '<div class="form-group row">';
                html +=
                  '<label class="col-3 col-form-label text-right align-self-center">Education</label>';
              ...
              for (var key in data_lines) {
                ...
                html += '<div class="form-group row">';
                html +=
                  '<label class="col-3 col-form-label text-right align-self-center">Industry</label>';
                html += '<div class="col-2 d-none align-self-center">';
                html +=
                  '<input value="' +
              ...
              for (var key in data_lines) {
                ...
                html += '<div class="form-group row">';
                html +=
                  '<label class="col-3 col-form-label text-right align-self-center">Job Level </label>';
                html += '<div class="col-2 d-none align-self-center">';
                html +=
                  '<input value="' +
              ...
              for (var key in data_lines) {
                ...
                html += '<div class="form-group row">';
                html +=
                  '<label class="col-3 col-form-label text-right align-self-center">Job Type </label>';
                html += '<div class="col-2 d-none align-self-center">';
                html +=
                  '<input value="' +
              ...
              for (var key in data_lines) {
                ...
                html += '<div class="form-group row">';
                html +=
                  '<label class="col-3 col-form-label text-right align-self-center">Department </label>';
                html += '<div class="col-2 d-none align-self-center">';
                html +=
                  '<input value="' +
              ...
              for (var key in data_lines) {
                ...
                if (map_data["status"] == "") {
                  ...
                  html += "<td>";
                  html +=
                    "<small>" + map_data["application_date"] + "</small><br/>";
                  html += "</td>";
                  html += "</tr>";
                } //end if
  ...
  function load_experience_form(param) {
    ...
    html += '<div class="form-group row">';
    html +=
      '<label class="col-4 col-form-label text-link">Company Name </label>';
    html += '<div class="col">';
    html +=
    ...
    html += '<div class="col">';
    html +=
      '<input type="checkbox" class="w-auto" checked value="false" id="row_experience[if_current][]"/>';
    html += "</div><!--./col-10-->";
    html += "</div><!--./form-group-->";
  ...
  function load_education_form(param) {
    ...
    html += '<div class="form-group row">';
    html +=
      '<label class="col-4 col-form-label text-link">University/School </label>';
    html += '<div class="col">';
    html +=
    ...
    html += '<div class="form-group row">';
    html +=
      '<label class="col-4 col-form-label text-link">Degree/Field of Study </label>';
    html += '<div class="col">';
    html +=
