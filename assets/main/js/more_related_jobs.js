                ...
                if(data.data !== null){
                    ...
                    $.each(data.data, function (key, value) {
                        ...
                        html += '<div class="row mb-2">';
                            html += '<div class="col">';
                                html += '<div class="card">';
                                    html += '<img onClick="window.open(\''+logo_url+value.employer+'\')" src="'+img_src+'" class="card-img-top js-cardimg" />';
                                    html += '<div class="card-body">';
                                        ...
                                        html += '<div class="row" style="font-size:10pt;">';
                                            html += '<div class="col">';
                                                html += '<small class="text-muted"><b>'+value.company_name+'</b></small>';
                                            html += '</div>';
                                            html += '<div class="col">';
                                                html += '<div class="text-right">';
