$(document).ready(function(){ 
            ...
            $.ajax({
                ...
                beforeSend : function(){
                    ...
                    if (data.success === true){
                        ...
                        $('#error_cont').html('<div class="alert alert-danger" style="min-width:100%;">'+msg_html+'</div>');
    ...
    function load_preference_form(param){
        ...
        html += '<form id="frm_'+param.type+'">';
           ...
           html += '<div class="form-group row">';
            ...
            html += '<div class="form-group row">';
                html += '<label class="col-3 col-form-label">Job Level <span class="text-danger fw-bolder">*</span></label>';
                html += '<div class="col-2 d-none">';
            ...
            html += '<div class="form-group row">';
                html += '<label class="col-3 col-form-label">Job Type <span class="text-danger fw-bolder">*</span></label>';
                html += '<div class="col-2 d-none">';
            ...
            html += '<div class="form-group row">';
                html += '<label class="col-3 col-form-label">Department <span class="text-danger fw-bolder">*</span></label>';
                html += '<div class="col-2 d-none">';
    ...
    function load_change_password_form(param){
        ...
        html += '<form id="frm_'+param.type+'">';
            ...
            html += '<div class="row">';
              html += '<label class="col-xl-4 col-lg-4 col-auto col-form-label">New Password <span class="text-danger fw-bolder">*</span></label>';
              html += '<div class="col">';
            ...
            html += '<div class="row">';
              html += '<label class="col-xl-4 col-lg-4 col-auto col-form-label">Confirm Password <span class="text-danger fw-bolder">*</span></label>';
              html += '<div class="col">';
            ...
            html += '<div class="row align-items-center justify-content-center mb-3">';
                html += '<label class="col-auto col-form-label text-primary text-right"><span class="fa fa-info-circle"></span></label>';
                html += '<div class="col-auto text-primary">';
                    html += '<small>Password must be min. of 8 chars with upper, lower case & number</small>';
                html += '</div>';
            html += '</div>';
                ...
                html += '<div class="card-body">';
                    ...
                    if ($(window).width() <= 1024) {
                        html += '<div class="form-group row">';
                            ...
                            html += '<div class="col-8 col-sm-8 col-md-6 col-lg-8 col-xl-8 align-self-center">';
                                html += '<div class="input-group input-group-sm">';
                                    html += '<input class="form-control form-control-sm" type="text" placeholder="MM/YYYY" name="row_education[start_date][]"/>';
                        ...
                        html += '<div class="form-group row">';
                            ...
                            html += '<div class="col-8 col-sm-8 col-md-6 col-lg-8 col-xl-8 align-self-center">';
                                html += '<div class="input-group input-group-sm date">';
                                    html += '<input class="form-control form-control-sm" type="text" placeholder="MM/YYYY" name="row_education[end_date][]"/>';
                                    html += '<div class="input-group-append">';
                                        html += '<span class="input-group-text"><i class="fa fa-calendar"></i></span>';
                                    html += '</div><!--./input-group-append-->';
                                html += '</div><!--./input-group input-group-sm-->';
        ...
        var html = '';
            ...
            html += '<div class="card mb-2">';
                ...
                html += '<div class="card-body">';
                    ...
                    html += '<div class="form-group row">';
                        html += '<label class="col-3 col-form-label text-right align-self-center"><span class="text-danger fw-bolder">*</span></label>';
                        html += '<div class="col-8 align-self-center">';
        ...
        var html = '';
            ...
            html += '<div>';
                ...
                html += '<div>';
                    ...
                    html += '<div class="form-group row">';
                        html += '<label class="col-3 col-form-label text-right align-self-center"></label>';
                        html += '<div class="col-8 align-self-center">';
                            html += '<div class="input-group input-group-sm">';
