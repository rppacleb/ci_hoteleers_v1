...
$(document).ready(function(){
    //highlight
    $('#side_account_management_prospect').removeClass('text-muted');
    $('#side_account_management_prospect').addClass('active');
    $('#side_account_management_prospect').css({'opacity': 0.8, "background-color": "rgb(0, 41, 170)"});
    ...
    //if($("#side_account_management").hasClass('active')){
    ...
    function load_record(page,type,container,pagination,loader,callback){
        ...
        var url         = baseurl + '/get/prospect/'+type;
        $.ajax({
            url: url,
            type: "POST",
            data: data,
                                    ...
                                    html += '<div class="card-body">';
                                        html += '<div class="row">';
                                            ...
                                            html += '<div class="text-center col-xl-2 col-lg-2 col-md-12 col-sm-12 col-xs-12 align-self-center" style="min-width:1in;">';
                                                ...
                                                html += '<a href="'+view_url+value.id+'?side_menu=side_account_management_prospect&type=prospect" class="text-link btn_view" style="padding: 0rem;">View</a>';
