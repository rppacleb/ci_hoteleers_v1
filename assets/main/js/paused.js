...
$(document).ready(function(){
    //highlight
    $('#side_account_management_paused').removeClass('text-muted');
    $('#side_account_management_paused').addClass('active');
    $('#side_account_management_paused').css({'opacity': 0.8, "background-color": "rgb(0, 41, 170)"});
    //end highlight
    ...
    //prospect
    load_record(0,'paused','paused_container','paused_pagination','paused_loader',function(){
    ...
    function load_record(page,type,container,pagination,loader,callback){
        ...
        if(type == 'active' || type == 'inactive' || type == 'paused'){
        ...
        var url         = baseurl + '/get/paused/'+type;
        $.ajax({
            url: url,
            type: "POST",
            data: data,
                                    ...
                                    html += '<div class="card-body">';
                                        html += '<div class="row">';
                                            ...
                                            if(type == 'prospect'){
                                                ...
                                                html += '<div class="col align-self-center">';
                                                    html += value.start_date.toUpperCase();
                                                html += '</div><!--./col-->';
                                                html += '<div class="col align-self-center">';
                                                    html += value.end_date.toUpperCase();
                                                html += '</div><!--./col-->';
                                            }//end if
                                            

                                            html += '<div class="text-center col-xl-2 col-lg-2 col-md-12 col-sm-12 col-xs-12 align-self-center" style="min-width:1in;">';
                                                
                                                   
                                                      
                                                html += '<a href="'+view_url+value.id+'?side_menu=side_account_management_paused&type=paused" class="mr-2 text-link btn_view">View</a>';
