$(document).ready(function () {
  ...
  $("#side_account_management_paused").css({
    opacity: 0.8,
      ...
      .done(function (data) {
        if (data.data !== null) {
          ...
          $.each(data.data, function (key, value) {
            ...
            html +=
              '<div class="text-center col-xl-2 col-lg-2 col-md-12 col-sm-12 col-xs-12 align-self-center" style="min-width:1in;">';

            html +=
              '<a href="' +
              view_url +
              value.id +
              '?side_menu=side_account_management_paused&type=paused" class="mr-2 text-link btn_view">View</a>';
