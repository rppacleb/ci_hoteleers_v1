    ...
    google.maps.event.addListener(map, 'click', function(e) {
        ...
        geocoder.geocode({
          ...
          if (response.results[0]) {
            ...
            $(frm+' textarea[name=header\\[location\\]]').val(response.results[0].formatted_address);
                                    ...
                                    html += '<div class="card-body">';
                                        html += '<div class="row">';
                                            html += '<div class="col align-self-center text-link">';
                                                html += value.application_date.toUpperCase();
                                            html += '</div><!--./col-->';
                                            ...
                                            html += '<div class="col align-self-center">';
                                                html += value.industry;
                                            html += '</div><!--./col-->';
                                            html += '<div class="text-left col-xl-2 col-lg-2 col-md-12 col-sm-12 col-xs-12 align-self-center" style="min-width:3.1in;">';
                                                //html += '<div class="outside_button btn-group btn-group-toggle">';
                                                    ...
                                                    if(value.status.toLowerCase() == 'declined'){
                                                        ...
                                                        if(declined == ""){
                                                            html += '<button aria-id="'+value.id+'" aria-type="2" aria-username="'+value.username+'" class="mr-2 '+approved+' btn btn-pill-sm btn-pill-outline-link text-link btn_submit">Approve</button>';
                                                        }else{
                                                            html += '<button disabled aria-id="'+value.id+'" aria-type="2" aria-username="'+value.username+'" class="mr-2 '+approved+' btn btn-pill-sm btn-pill-outline-link text-link btn_submit">Approve</button>';
                                                        }//end if
                                                        if(approved == ""){
