...
$(document).ready(function(){
    ...
    $('#side_talent_database').css({'opacity': 0.8, "background-color": "rgb(0, 41, 170)"});
    //end highlight
    ...
    function load_record(page,type,container,pagination,loader){
        ...
        $.ajax({
            ...
            beforeSend : function(){
                ...
                console.log(JSON.stringify(data.qrystr));
                                ...
                                html += '<div class="card">';
                                    html += '<div class="card-body">';
                                        html += '<div class="row">';
                                            ...
                                            html += '</div><!--./col-->';
                                            html += '<div class="col-1 align-self-center text-break as-namespacer">';
                                                html += value.name;
                                            ...
                                            html += '<div class="text-center col-xl-2 col-lg-2 align-self-center" style="min-width:1.6in;">';
                                                //html += '<div class="btn-group btn-group-toggle">';
                                                    ...
                                                    html += '<a href="'+view_url+value.id+'?mod_type=side_talent_database" class="btn btn-pill-sm btn-pill-outline-link text-link btn_view">View</a>';
