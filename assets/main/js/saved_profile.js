      ...
      .done(function (data) {
        if (data.data !== null) {
          ...
          $.each(data.data, function (key, value) {
            ...
            html += "</div><!--./col-->";
            html +=
              '<div class="col align-self-center text-break as-namespacer">';
            html += value.name;
            html += "</div><!--./col-->";
            ...
            html +=
              ...
              view_url +
              value.id +
              '?mod_type=side_saved_profile" class="btn btn-pill-sm btn-pill-outline-link text-link btn_view">View</a>';
