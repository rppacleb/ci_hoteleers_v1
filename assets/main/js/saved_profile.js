...
$(document).ready(function(){
    //highlight
    $('#side_saved_profile').removeClass('text-muted');
    $('#side_saved_profile').addClass('active');
    $('#side_saved_profile').css({'opacity': 0.8, "background-color": "rgb(0, 41, 170)"});
    //end highlight
    ...
    var homeurl     = baseurl + '/saved_profile';
    var homeurl_txt = 'saved_profile';
                                ...
                                html += '<div class="card">';
                                    html += '<div class="card-body">';
                                        html += '<div class="row">';
                                            ...
                                            html += '</div><!--./col-->';
                                            html += '<div class="col align-self-center text-break as-namespacer">';
                                                html += value.name;
                                            html += '</div><!--./col-->';
                                            ...
                                            html += '<div class="text-center col-xl-2 col-lg-2 align-self-center" style="min-width:1.6in;">';
                                                //html += '<div class="btn-group btn-group-toggle">';
                                                    ...
                                                    html += '<button aria-saved="'+parseInt(value.profile_saved)+'" aria-id="'+value.id+'" class="mr-2 btn '+btn_class+' btn_save_profile">'+logo+'</button>';
                                                    

                                                    //html += '<button '+btn_class+' aria-id="'+value.id+'" class="btn btn-pill-sm btn-pill-outline-link text-link btn_save_profile">Save</button>';
                                                    html += '<a href="'+view_url+value.id+'?mod_type=side_saved_profile" class="btn btn-pill-sm btn-pill-outline-link text-link btn_view">View</a>';
