$(document).ready(function () {
  ...
  function load_record(page, type, container, pagination, loader) {
    ...
    var url = baseurl + "/get/account_management/" + type;
    $.ajax({
      url: url,
      type: "POST",
      data: data,
  ...
  $(document.body).on("click", "button.btn_submit", function (e) {
    ...
    var url = homeurl;
    url = baseurl + "/account_management/submit_data";
    ...
    if (confirm("Are you sure you want to " + type_text + " this Employer?")) {
      $.ajax({
        url: url,
        type: "POST",
        ...
        .done(function (data) {
          ...
          if (data.success === true) {
            ...
            var view_url = baseurl + "/account_management";
            if (side_menu == "side_account_management") {
              view_url = baseurl + "/account_management";
            }
            if (side_menu == "side_account_management_prospect") {
              view_url = baseurl + "/prospect";
            } //end if
  ...
  function load_data(param) {
    var url = baseurl + "/account_management/load_data/" + param.id;
    var btn = $(".btn_submit");
    ...
    $.ajax({
      ...
      .done(function (data) {
        if (data.data !== null) {
          ...
          $(".company_name_breadcrumbs").html(data.data.company_name);
          ...
          if (param.mode == "view") {
            $(
              "#frm_data_entry > #edit_view input:not([readonly]),textarea:not([readonly]),select"
            ).addClass(param.mode);
            ...
            $(
              "#frm_data_entry > #edit_view button." +
                param.mode +
