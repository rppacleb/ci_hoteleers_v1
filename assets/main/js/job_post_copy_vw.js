...
$(document).ready(function(){
   ...
   //alert(moment('4/30/2016', 'MM/DD/YYYY').add(1, 'day'));
    ...
    function load_data(param){
        var url         = homeurl + '/load_data/'+param.id+'?isActive='+isActive+'&user_id='+user_id+'&employer_id='+employer_id+'&isActive='+isActive;
        var btn         = $('.btn_submit');
        ...
        $.ajax({
            ...
            if(response.data !== null){
                ...
                if(param.mode == 'edit' || param.mode == 'view' || param.mode == 'copy'){
                    //view and edit mode
                    //----------------------------------------------------------------------------------------------------
