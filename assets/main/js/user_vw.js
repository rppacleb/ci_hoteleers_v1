$(document).ready(function(){
    ...
    if(side_menu !== ""){
        ...
        $('#side_employers').css({'opacity': 0.8, "background-color": "rgb(0, 41, 170)"});
    }//end if
    //end highlight
   ...
   //alert(moment('4/30/2016', 'MM/DD/YYYY').add(1, 'day'));
    ...
    function load_data(param){
        var url         = homeurl + '/load_data/'+param.id+'?is_archived='+is_archived;
        ...
        $.ajax({
            ...
            if(response.data !== null){
                ...
                if(param.mode == 'edit' || param.mode == 'view'){
                    //view and edit mode
                    //----------------------------------------------------------------------------------------------------
                     $('#frm_data_entry input[name=header\\[employer\\]]').val(data.employer); 
                     $('#frm_data_entry select[name=header\\[honorifics\\]]').val(data.honorifics);
                     ...
                     $('#frm_data_entry input[name=header\\[designation\\]]').val(data.designation);
                     ...
                     $('#frm_data_entry input[name=header\\[password\\]]').val(data.password);
                    //----------------------------------------------------------------------------------------------------
