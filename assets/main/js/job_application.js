...
$(document).ready(function(){
    ...
    if ($(window).width() <= 480) {
        ...
        $('.mobile-jssearchrow').removeClass('mb-5');
        $('hr').css('display', 'none');
    ...
    var homeurl     = baseurl + '/job_application';
    var homeurl_txt = 'job_application';
                    ...
                    $.each(data.data, function (key, value) {
                        ...
                        if ($(window).width() <= 480) {
                            ...
                            if ($(window).width() <= 480 && $(window).width() >= 376) {
                                html += '<img src="'+img_src+'" class="card-img-top" style="height:330px; padding: 0.75rem;" />';
                            } else if ($(window).width() <= 375) {
                                html += '<img src="'+img_src+'" class="card-img-top" style="height:290px; padding: 0.75rem;" />';
                            }
                          ...
                          $('#'+container+'').append(html);
                            ...
                            html += '<div class="col"style="min-height:2.5in;">';
                                html += '<div class="card">';
                                    html += '<img onClick="window.open(\''+logo_url+value.employer+'\')" src="'+img_src+'" class="card-img-top js-cardimg " style="height:300px; padding: 0.75rem;" class="card-img-top" />';
                                    html += '<div class="card-body">';
                                        ...
                                        html += '<a href="'+view_url+value.id+'" style="text-decoration:none;"><h6 class="card-title text-link">'+value.job_title+'</h6></a>';

                                        html += '<div class="row" style="font-size:10pt;">';
                                            html += '<div class="col col-md-8 mt-2">';
                                                html += '<a href="'+baseurl+'/company_info_public/view/'+value.employer+'" class="text-link text-decoration-none"><small<b>'+value.company_name+'</b></small></a>';
                                            html += '</div>';
                                            html += '<div class="col">';
                                                html += '<div class="text-right">';
                                        ...
                                        html += '<div class="row mb-3" style="font-size:10pt;">';
                                            ...
                                            html += '<div class="col">';
                                                html += '<div class="text-right">';
                                                    html += '<small class="text-muted text-right"><b>'+value.job_expiration_date+'</b></small>';
                                                html += '</div>';
                                            html += '</div>';
                                        html += '</div>';
                                            ...
                                            html += '<div class="col">';
                                                html += '<div class="text-right">';
                                                    //html += '<div class="btn-group">';
                                                            ...
                                                            //html += '<button '+btn_attr+' class="mr-3 btn btn-pill-sm btn-pill-outline-link text-link btn_add_fav" aria-id="'+value.id+'"><i class="fa fa-heart"></i></button>';
