      ...
      .done(function (data) {
        if (data.data !== null) {
          ...
          $.each(data.data, function (key, value) {
            ...
            html += "</div><!--./col-->";
            html +=
              '<div class="col-xl-2 col-lg-2 col-md-12 col-sm-12 col-xs-12 text-left align-self-center" style="min-width:3in;">';
            ...
            html +=
              ...
              view_url +
              value.id +
              '" class="mr-2 btn btn-pill-sm btn-pill-outline-link text-link btn_view">View</a>';

            if (value.activated == "Activated") {
              html +=
                '<a href="#" class="btn btn-pill-sm btn-pill-outline-success btn_view" disabled>Active</a>';
            } else if (value.activated == "Pending") {
              html +=
                '<a href="#" class="btn btn-pill-sm btn-pill-outline-muted btn_view">Activate</a>';
            } else {
              html +=
                '<a href="#" class="btn btn-pill-sm btn-pill-outline-muted btn_view">Inactive</a>';
            }
