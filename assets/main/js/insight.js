...
$(document).ready(function(){
    ...
    $('#side_insight').css({'opacity': 0.8, "background-color": "rgb(0, 41, 170)"});
    //end highlight
    ...
    var homeurl     = baseurl + '/insight';
    var homeurl_txt = 'insight';
    ...
    function load_record(page,type,container,pagination,loader,callback){
        ...
        let view_url = baseurl + '/active_jobs_applicant?job_post=';
                                ...
                                html += '<div class="card">';
                                    html += '<div class="card-body">';
                                        html += '<div class="row">';
                                            ...
                                            //html += '</div><!--./col-->';
                                            html += '<div class="col-1 align-self-center text-muted text-center" style="max-width: 7.3%;">';
                                                html += value.id;
                                            html += '</div><!--./col-->';
                                            html += '<div class="col align-self-center text-break" style="min-width:1in;">';
                                                //html += value.job_title;


                                                
                                                html += '<a style="text-decoration:none;" href="'+view_url+'" class="text-link">'+job_title_placeholder+'</a>';
                                            html += '</div><!--./col-->';
                                            ...
                                            html += '<div class="col-xl-1 col-lg-1 align-self-center text-center d-none" style="min-width:1.5in;">';
                                                ...
                                                //html += '<div class="btn-group btn-group-toggle">';
                                                    html += '<button data-toggle="modal" data-target="#pie_chart_modal" type="button" data-id="'+value.id+'" class="btn btn-pill-sm btn-pill-sm-outline-light text-muted mr-1 btn_save"><i class="fa fa-pie-chart"></i></button>';
    ...
    //find
    $(document.body).on('blur','input[name=header\\[keyword_hired\\]]',function(e){
        var type = $(this).attr('aria-type');
    ...
    //find
    $(document.body).on('blur','input[name=header\\[keyword_active\\]]',function(e){
        var type = $(this).attr('aria-type');
        load_record(0,type,type+'_container',type+'_pagination',type+'_loader');
    })//end if
    //end find
    ...
    //find
    $(document.body).on('blur','input[name=header\\[keyword_deactivated\\]]',function(e){
        var type = $(this).attr('aria-type');
        load_record(0,type,type+'_container',type+'_pagination',type+'_loader');
    })//end if
    //end find
            ...
            if(response.data !== null && response.data !== undefined){
              ...
              for(var key in response.data){
               ...
               for(var key in response.data){
                                ...
                                html += '<div class="card-body">';
                                    html += '<div class="row">';
                                        html += '<div class="col-1 align-self-center text-center">';
                                            html += '<span class="dot" style="background-color:'+colors[key]+'"></span> ';
                                        html += '</div><!--./col-->';

                                        html += '<div class="col align-self-center fw-bolder text-left text-muted">';
                                        ...
                                        html += '</div><!--./col-->';
                                        html += '<div class="col-3 align-self-center fw-bolder text-muted text-center">';
                                            html += percentage;
                                        html += '</div><!--./col-->';
                                        html += '<div class="col-3 align-self-center fw-bolder text-muted text-center">';
                    ...
                    param.data[param.data.length] = new Array(response.data[key].country,parseInt(response.data[key].count));
