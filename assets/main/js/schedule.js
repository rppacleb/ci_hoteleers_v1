        ...
        if (data.data !== null) {
          ...
          $.each(data.data, function (key, value) {
            ...
            html +=
              ...
              "?job_post=" +
              value.job_post_id +
              '&mod_type=side_schedule" class="text-link">' +
              value.name +
              "</a>";
            html += "</div><!--./col-->";
            ...
            if ($(window).width() <= 1440 && $(window).width() >= 1380) {
              ...
              if (job_title_placeholder_length > 20) {
                ...
                html +=
                  '<div class="col align-self-center text-left"><h5 style="font-size: 15px; font-weight: 400; font-family: Be Vietnam Pro, sans-serif; margin-top: auto; margin-bottom: auto;" class="text-break" data-schedjob="' +
                  value.job_title +
                  '">';
            ...
            html +=
              '<div class="text-center col-xl-2 col-lg-2 align-self-center" style="min-width:2in;">';
            ...
            html +=
              ...
              value.job_post_id +
              "" +
              '" class="mr-2 btn btn-pill-sm btn-pill-sm-outline-light text-muted btn_save" title="Edit"><i class="fa fa-pencil"></i></a>';
            html +=
              '<a href="' +
              view_url +
              value.id +
              ...
              value.job_post_id +
              "" +
              '" class="btn btn-pill-sm btn-pill-outline-link text-link btn_view"><i class="fa fa-calendar-check" aria-hidden="true" style="font-size: 16px"></i></a>';
