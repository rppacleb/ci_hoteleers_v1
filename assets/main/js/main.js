...
$(document.body).on('click','button[name=header\\[btn_find_job\\]]',function(){
    var search_str = $('input[name=header\\[find_job_search\\]]').val();
    var search_url = baseurl + '/job_search/private?search_str='+encodeURI(search_str);
    window.location = search_url;
});

// Search job on Enter key press
$(document.body).on('keypress','input[name=header\\[find_job_search\\]]',function(e){
    if(e.which == 13){
...
function load_record(page,type,container,pagination,loader){
    ...
    $.ajax({
        ...
        dataType: "JSON",
        beforeSend : function(){
            $('#trending_jobs_container').html('<div class="col-2"></div><div class="col text-center"><div class="spinner-grow text-muted"></div><div class="col-2"></div></div>');
                ...
                $.each(data.data, function (key, value) {
                    ...
                    if(ctr == 1){
                        ...
                        if ($(window).width() >= 1025 ) {
                            html += '<div class="col-xl-3 col-lg-3 col-md-6 padding-0" style="float:left;width:1.5in;"> </div>';
                        }
                    }//end if
                    ...
                    //html += '<div class="carousel-item '+active+'">';
                        ...
                        html += '<div class="col-xl-3 col-lg-3 col-md-6 padding-0" style="float:left;min-width:2.5in;">';
                          html += '<div class="card mb-2 mx-1 home-trendingcard" style="min-height:4.2in;">';
                          if ($(window).width() >= 1900) {
                            html += '<img style="height:275px; padding: 0.75rem;" class="card-img-top"';
                          } else if ($(window).width() >= 1500 && $(window).width() <= 1899) {
                            html += '<img style="height:250px; padding: 0.75rem;" class="card-img-top"';
                          } else if ($(window).width() >= 1281 && $(window).width() <= 1499) {
                            html += '<img style="height:250px; padding: 0.75rem;" class="card-img-top"';
                          } else if ($(window).width() <= 1024) {
                            html += '<img style="height:300px; padding: 0.75rem;" class="card-img-top"';
                          } else {
                            html += '<img style="height:230px; padding: 0.75rem;" class="card-img-top"';
                          }
                                 html += 'src="'+img_src+'" title="'+value.company_name+'" alt="'+value.company_name+'">';
                            ...
                            if ($(window).width() <= 1280 && $(window).width() >= 1024) {
                                ...
                                if(job_title_placeholder_length > 17){
                                    ...
                                    html += '<a href="'+view_url+value.id+'" style="text-decoration:none;"><h5 class="text-link" data-maintitle="'+value.job_title+'">'+job_title_placeholder+'</h5></a>';
                                } else {
                                    html += '<a href="'+view_url+value.id+'" style="text-decoration:none;"><h5 class="text-link">'+job_title_placeholder+'</h5></a>';
                                }
                                ...
                                if(company_placeholder_length > 17){
                                    ...
                                    html += '<small class="text-muted" style="font-size:9pt !important"><b data-companyname="'+value.company_name+'" style="font-size:15px !important">'+company_placeholder+'</b></small>';
                                } else {
