...
function initMap() {
  ...
  autocomplete.addListener("place_changed", () => {
    ...
    $(frm + " input[name=header\\[lat\\]]").val(
      place.geometry["location"].lat()
    );
    $(frm + " input[name=header\\[lng\\]]").val(
    ...
    if (dup == 0) {
      ...
      html_txt +=
        '<button type="button" title="Remove" class="text-danger close remove_append">&times;</button>';
      html_txt +=
        '<small class="d-none"><a style="text-decoration:none;" class="edit_link_locality">' +
        locality +
        "</a></small>";
      html_txt +=
        '<small class="d-none"><a style="text-decoration:none;" class="edit_link_administrative_area_level_1">' +
        administrative_area_level_1 +
        "</a></small>";
      html_txt +=
        '<small class="d-none"><a style="text-decoration:none;" class="edit_link_country">' +
        country +
        "</a></small>";

      html_txt +=
        '<small><a style="text-decoration:none;" class="edit_link">' +
        place.formatted_address +
        "</a></small>";
...
$(document).ready(function () {
  //highlight
  if (
    mod_type == "side_deactivated" ||
    mod_type == "side_hired_jobs" ||
      ...
      .done(function (data) {
        ...
        if (data.data !== null) {
          ...
          $.each(data.data, function (key, value) {
            ...
            html += "</div><!--./col-->";
            html +=
              '<div class="col align-self-center" style="min-width:1.7in;">';
            html +=
              '<a href="' +
              view_url +
              value.id +
              ...
              "&mod_type=" +
              mod_type +
              '" style="color: #3f5d97;text-decoration: none;"><b>' +
              value.name +
              "</b></a>";
            html += "</div><!--./col-->";
            ...
            if ($(window).width() <= 1600 && $(window).width() >= 1380) {
              ...
              if (job_title_placeholder_length > 13) {
                ...
                html +=
                  '<div class="col align-self-center"><h5 style="font-size: 15px; font-weight: 400; font-family: Be Vietnam Pro, sans-serif; margin-top: auto; margin-bottom: auto;" data-ajacurrjob="' +
                  value.current_job +
                  '">';
              ...
              if (company_placeholder_length > 15) {
                ...
                html +=
                  '<div class="col align-self-center"><h5 style="font-size: 15px; font-weight: 400; font-family: Be Vietnam Pro, sans-serif; margin-top: auto; margin-bottom: auto;" data-ajacompany="' +
                  value.company_name +
                  '">';
            ...
            if (value.interview_status !== undefined) {
              ...
              html +=
                ...
                border +
                '">' +
                toPascalCase(value.interview_status) +
                "</span>";
              html += "</div><!--./col-->";
              html += "</div><!--./row-->";
            } //end if
                  ...
                  if (data["data_notification"][value.id] !== undefined) {
                    ...
                    for (const k in notification_record) {
                      ...
                      html +=
                        "<span class='" +
                        class_status +
                        " text-break'>Invited to " +
                        m_data["job_title"].toLowerCase() +
                        " | " +
                        toPascalCase(m_data["status"]) +
                        "</span><br/>";
                    } //end for
                  } //end if
                } //end if
