        ...
        if (data.data !== null) {
          ...
          $.each(data.data, function (key, value) {
            ...
            html +=
              ...
              view_url +
              value.id +
              '&status=closed&mod_type=side_hired_jobs" class="text-link">' +
            ...
            html +=
              ...
              view_url +
              value.id +
              '&status=closed&mod_type=side_hired_jobs" class="btn btn-pill-sm btn-pill-outline-link text-link btn_view">View</a>';
