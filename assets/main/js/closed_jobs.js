...
$(document).ready(function(){
    ...
    var homeurl     = baseurl + '/closed_jobs';
    var homeurl_txt = 'closed_jobs';
                                    ...
                                    html += '<div class="card-body">';
                                        html += '<div class="row">';
                                            ...
                                            html += '<div class="col align-self-center text-link" style="min-width:1in;">';
                                                ...
                                                html += '<a style="text-decoration:none;" href="'+view_url+value.id+'&status=closed&mod_type=side_hired_jobs" class="text-link">'+job_title_placeholder+'</a>';
                                            html += '</div><!--./col-->';
                                            ...
                                            html += '<div class="col-xl-2 col-lg-2 align-self-center text-center" style="min-width:1.5in;">';
                                                ...
                                                //html += '<div class="btn-group btn-group-toggle">';
                                                    ...
                                                    html += '<a href="'+view_url+value.id+'&status=closed&mod_type=side_hired_jobs" class="btn btn-pill-sm btn-pill-outline-link text-link btn_view">View</a>';
