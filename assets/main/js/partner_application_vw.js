                                        ...
                                        html += '<div class="row">';
                                            ...
                                            html += '<div class="col">';
                                                ...
                                                if(value.status.toLowerCase() == 'declined'){
                                                    ...
                                                    html += '<button data-id="'+value.id+'" data-type="partner_application" data-toggle="modal" data-target="#edit_modal" data-title="" class="btn btn-pill-sm btn-pill-outline-link text-link btn_view">View</button>';
    ...
    function load_edit_form(param){
        ...
        html += '<form id="frm_'+param.type+'_edit">';
            ...
            html += '<div class="form-group row">';
                ...
                html += '<div class="col">';
                  html += '<input readonly class="form-control form-control-sm mb-2" type="text" aria-type="'+param.type+'" name="header[id]"/>';
                html += '</div>';
            html += '</div>';
            ...
            html += '<div class="form-group row">';
                ...
                html += '<div class="col">';
                      html += '<input value="" Placeholder="Email" name="header[username]" type="text" class="form-control form-control-sm" maxlength="100">';
                html += '</div><!--./col-->';
            html += '</div><!--./row-->';
            ...
            html += '<div class="form-group row">';
                ...
                html += '<div class="col">';
                    html += '<div class="input-group">';
                        html += '<input value="" Placeholder="Password" name="header[password]" type="password" class="form-control form-control-sm" maxlength="50">';
                        html += '<div class="input-group-append input-group-addon btn_show_pass" aria-type="password" data-toggle="tooltip" data-placement="bottom" title="Minimum 8 characters with upper case, lower case and number">';
            ...
            html += '<div class="form-group row">';
                html += '<label class="col-3 col-form-label">Honorifics <span class="text-danger fw-bolder">*</span></label>';
                html += '<div class="col">';
                    html += '<select class="custom-select custom-select-sm" name="header[honorifics]">';
            ...
            html += '<div class="form-group row">';
                html += '<label class="col-3 col-form-label">First Name <span class="text-danger fw-bolder">*</span></label>';
                html += '<div class="col">';
                    html += '<input class="form-control form-control-sm" type="text" name="header[first_name]" maxlength="100"/>';
                html += '</div><!--./col-10-->';
            html += '</div><!--./form-group-->';
            html += '<div class="form-group row">';
                html += '<label class="col-3 col-form-label">Last Name <span class="text-danger fw-bolder">*</span></label>';
                html += '<div class="col">';
                    html += '<input class="form-control form-control-sm" type="text" name="header[last_name]" maxlength="100"/>';
                html += '</div><!--./col-10-->';
            html += '</div><!--./form-group-->';
            html += '<div class="form-group row">';
                html += '<label class="col-3 col-form-label">Work Email <span class="text-danger fw-bolder">*</span></label>';
                html += '<div class="col">';
                    html += '<input placeholder="email@email.com" class="form-control form-control-sm" type="text" name="header[work_email]" maxlength="100"/>';
                html += '</div><!--./col-10-->';
            html += '</div><!--./form-group-->';
            html += '<div class="form-group row">';
                html += '<label class="col-3 col-form-label">Contact Number <span class="text-danger fw-bolder">*</span></label>';
                ...
                html += '</div><!--./col-10-->';
                html += '<div class="col">';
                    html += '<input placeholder="917XXXXXXX" class="form-control form-control-sm" type="text" name="header[contact_number]" maxlength="20"/>';
                html += '</div><!--./col-10-->';
            html += '</div><!--./form-group-->';
            html += '<div class="form-group row">';
                html += '<label class="col-3 col-form-label">Company Name <span class="text-danger fw-bolder">*</span></label>';
                html += '<div class="col">';
                    html += '<input class="form-control form-control-sm" type="text" name="header[company_name]" maxlength="100"/>';
                html += '</div><!--./col-10-->';
            html += '</div><!--./form-group-->';
            ...
            html += '<div class="form-group row">';
              html += '<label class="col-3 col-form-label">Location <span class="text-danger fw-bolder">*</span></label>';
              html += '<div class="col">';
                html += '<input class="form-control form-control-sm" type="text" id="search_location"/>';
              html += '</div><!--./col-10-->';
            html += '</div><!--./form-group-->';
            ...
            html += '<div class="form-group row d-none">';
                html += '<label class="col-3 col-form-label">Location <span class="text-danger fw-bolder">*</span></label>';
                html += '<div class="col">';
                    html += '<textarea readonly class="form-control form-control-sm" name="header[location]"/></textarea>';
                html += '</div><!--./col-10-->';
            html += '</div><!--./form-group-->';
            ...
            html += '<div class="form-group row d-none">';
              ...
              html += '<div class="col">';
                html += '<input readonly class="form-control form-control-sm" type="text" name="header[country]"/>';
              html += '</div><!--./col-10-->';
            html += '</div><!--./form-group-->';
            ...
            html += '<div class="form-group row">';
                html += '<label class="col-3 col-form-label">Designation <span class="text-danger fw-bolder">*</span></label>';
                html += '<div class="col">';
                    html += '<input class="form-control form-control-sm" type="text" name="header[designation]" maxlength="100"/>';
                html += '</div><!--./col-10-->';
            html += '</div><!--./form-group-->';
            html += '<div class="form-group row">';
        ...
        html += '<div class="text-right">';
            html += '<button class="btn btn-primary btn-pill text-white btn-sm btn_update" type="button" aria-type="'+param.type+'">Update</button>';
        html += '</div>';
        return html;
    }//end if
    //=======================================================================================================================
    ...
    function load_data(param){
        ...
        $.ajax({
            ...
            if(data.data !== null){
                ...
                $('#frm_data_entry input[name=header\\[username\\]]').val(data.data.username);
                $('#frm_data_entry input[name=header\\[password\\]]').val(data.data.password);
                $('#frm_data_entry select[name=header\\[honorifics\\]]').val(data.data.honorifics);
                $('#frm_data_entry input[name=header\\[first_name\\]]').val(data.data.first_name);
                $('#frm_data_entry input[name=header\\[last_name\\]]').val(data.data.last_name);
                $('#frm_data_entry input[name=header\\[work_email\\]]').val(data.data.work_email);
                $('#frm_data_entry select[name=header\\[dial_code\\]]').val(data.data.dial_code);
                $('#frm_data_entry input[name=header\\[contact_number\\]]').val(data.data.contact_number);
                $('#frm_data_entry input[name=header\\[company_name\\]]').val(data.data.company_name);
                $('h6[id=header\\[company_name\\]]').html(data.data.company_name);
                
                $('#frm_data_entry input[name=header\\[location\\]]').val(data.data.location);
                $('p[id=header\\[location\\]]').html('<small class="text-muted">'+data.data.location+'</small>');

                
                
                $('#frm_data_entry input[name=header\\[country\\]]').val(data.data.country);
                $('#frm_data_entry input[name=header\\[designation\\]]').val(data.data.designation);
                $('#frm_data_entry input[name=header\\[industry\\]]').val(data.data.industry);
                $('#frm_data_entry input[id=header\\[industry_text\\]]').val(data.data.industry_text);
                $('p[id=header\\[date_created\\]]').html('<small class="text-muted">Joined '+data.data.joined_date+'</small>');
                ...
                if(param.mode == 'view'){
                    $('#frm_data_entry input:not([readonly]),textarea:not([readonly]),select').addClass(param.mode);
