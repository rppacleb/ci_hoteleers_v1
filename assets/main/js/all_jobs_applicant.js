...
$(document).ready(function(){
    ...
    if ($(window).width() >= 1441 ) {
        ...
        $('.aja-analytics').css({'width': '1.65in'});
        ...
        $('.aja-analytics').css({'width': '1.45in'});
    }

    if (window.location.href.indexOf("?view_type=short_listed") > -1) {
        $('.ajj-title').html('Active Jobs - Shortlisted');
    }

    if (window.location.href.indexOf("?view_type=interviews") > -1) {
        $('.ajj-title').html('Active Jobs - Interviews');
    }

    if (window.location.href.indexOf("?view_type=offered") > -1) {
        $('.ajj-title').html('Active Jobs - Offered');
    }

    if (window.location.href.indexOf("?status=closed") > -1) {
        $('#side_active_jobs').removeClass('active');
        $('#side_active_jobs').addClass('text-muted');
        $('#side_active_jobs').css({'background': 'none', 'opacity': 1});
        $('#side_hired_jobs').removeClass('text-muted');
        $('#side_hired_jobs').addClass('active');
        $('#side_hired_jobs').css({'opacity': 0.8, "background-color": "rgb(0, 41, 170)"});
        $('.ajj-title').html('Closed Jobs - Applicants');
    }

    if (window.location.href.indexOf("?view_type=short_listed&status=closed") > -1) {
        $('#side_active_jobs').removeClass('active');
        $('#side_active_jobs').addClass('text-muted');
        $('#side_active_jobs').css({'background': 'none', 'opacity': 1});
        $('#side_hired_jobs').removeClass('text-muted');
        $('#side_hired_jobs').addClass('active');
        $('#side_hired_jobs').css({'opacity': 0.8, "background-color": "rgb(0, 41, 170)"});
        $('.ajj-title').html('Closed Jobs - Shortlisted');
    }

    if (window.location.href.indexOf("?view_type=interviews&status=closed") > -1) {
        $('#side_active_jobs').removeClass('active');
        $('#side_active_jobs').addClass('text-muted');
        $('#side_active_jobs').css({'background': 'none', 'opacity': 1});
        $('#side_hired_jobs').removeClass('text-muted');
        $('#side_hired_jobs').addClass('active');
        $('#side_hired_jobs').css({'opacity': 0.8, "background-color": "rgb(0, 41, 170)"});
        $('.ajj-title').html('Closed Jobs - Interviews');
    }

    if (window.location.href.indexOf("?view_type=offered&status=closed") > -1) {
        $('#side_active_jobs').removeClass('active');
        $('#side_active_jobs').addClass('text-muted');
        $('#side_active_jobs').css({'background': 'none', 'opacity': 1});
        $('#side_hired_jobs').removeClass('text-muted');
        $('#side_hired_jobs').addClass('active');
        $('#side_hired_jobs').css({'opacity': 0.8, "background-color": "rgb(0, 41, 170)"});
        $('.ajj-title').html('Closed Jobs - Offered');
    }

    if (window.location.href.indexOf("?status=deactivated") > -1) {
        $('#side_active_jobs').removeClass('active');
        $('#side_active_jobs').addClass('text-muted');
        $('#side_active_jobs').css({'background': 'none', 'opacity': 1});
        $('#side_deactivated').removeClass('text-muted');
        $('#side_deactivated').addClass('active');
        $('#side_deactivated').css({'opacity': 0.8, "background-color": "rgb(0, 41, 170)"});
        $('.ajj-title').html('Deactivated Jobs - Applicants');
    }

    if (window.location.href.indexOf("?view_type=short_listed&status=deactivated") > -1) {
        $('#side_active_jobs').removeClass('active');
        $('#side_active_jobs').addClass('text-muted');
        $('#side_active_jobs').css({'background': 'none', 'opacity': 1});
        $('#side_deactivated').removeClass('text-muted');
        $('#side_deactivated').addClass('active');
        $('#side_deactivated').css({'opacity': 0.8, "background-color": "rgb(0, 41, 170)"});
        $('.ajj-title').html('Deactivated Jobs - Shortlisted');
    }

    if (window.location.href.indexOf("?view_type=interviews&status=deactivated") > -1) {
        $('#side_active_jobs').removeClass('active');
        $('#side_active_jobs').addClass('text-muted');
        $('#side_active_jobs').css({'background': 'none', 'opacity': 1});
        $('#side_deactivated').removeClass('text-muted');
        $('#side_deactivated').addClass('active');
        $('#side_deactivated').css({'opacity': 0.8, "background-color": "rgb(0, 41, 170)"});
        $('.ajj-title').html('Deactivated Jobs - Interviews');
    }

    if (window.location.href.indexOf("?view_type=offered&status=deactivated") > -1) {
        $('#side_active_jobs').removeClass('active');
        $('#side_active_jobs').addClass('text-muted');
        $('#side_active_jobs').css({'background': 'none', 'opacity': 1});
        $('#side_deactivated').removeClass('text-muted');
        $('#side_deactivated').addClass('active');
        $('#side_deactivated').css({'opacity': 0.8, "background-color": "rgb(0, 41, 170)"});
        $('.ajj-title').html('Deactivated Jobs - Offered');
    }

    var homeurl     = baseurl + '/all_jobs_applicant';
    var homeurl_txt = 'all_jobs_applicant';
                                ...
                                html += '<div class="card">';
                                    html += '<div class="card-body">';
                                        html += '<div class="row">';
                                            ...
                                            html += '</div><!--./col-->';
                                            html += '<div class="col align-self-center" style="min-width:1in;">';
                                                html += '<a href="'+view_url+value.id+'?job_post='+value.job_post_id+'" style="color: #3f5d97;text-decoration: none;"><b>'+value.name+'</b></a>';
                                            html += '</div><!--./col-->';
                                            ...
                                            if ($(window).width() <= 1440 && $(window).width() >= 1380) {
                                                ...
                                                if(job_title_placeholder_length > 20){
                                                    ...
                                                    html += '<div class="col align-self-center"><h5 style="font-size: 15px; font-weight: 400; font-family: Be Vietnam Pro, sans-serif; margin-top: auto; margin-bottom: auto;" class="text-break" data-ajacurrjob="'+value.current_job+'">';
                                                ...
                                                if(company_placeholder_length > 20){
                                                    ...
                                                    html += '<div class="col align-self-center"><h5 style="font-size: 15px; font-weight: 400; font-family: Be Vietnam Pro, sans-serif; margin-top: auto; margin-bottom: auto;" class="text-break" data-ajacompany="'+value.company_name+'">';
                                                ...
                                                if(job_title_placeholder_length > 22){
                                                    job_title_placeholder = job_title_placeholder+'...';
                                                    html += '<div class="col align-self-center"><h5 class="text-break" style="font-size: 15px; font-weight: 400; font-family: Be Vietnam Pro, sans-serif; margin-top: auto; margin-bottom: auto;" data-ajacurrjob="'+value.current_job+'">';
                                                        html += job_title_placeholder;
                                                    html += '</h5></div><!--./col-->';
                                                } else {
                                                    html += '<div class="col align-self-center">';
                                            ...
                                            html += '<div class="text-center col-xl-2 col-lg-2 align-self-center" style="min-width:1.6in;">';
                                                //html += '<div class="btn-group btn-group-toggle">';
                                                    ...
                                                    html += '<a href="'+view_url+value.id+'?job_post='+value.job_post_id+'" class="btn btn-pill-sm btn-pill-outline-link text-link btn_view">View</a>';
    ...
    function load_filter_dropdowns(){
        ...
        var url     = baseurl + "/get/job_post/olanguage";
        ...
        var url     = baseurl + "/get/job_post/oyear";
