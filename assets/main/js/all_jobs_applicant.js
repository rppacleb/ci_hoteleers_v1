$(document).ready(function () {
  ...
  if (
    window.location.href.indexOf("?view_type=short_listed&status=closed") > -1
  ) {
    $("#side_active_jobs").removeClass("active");
    $("#side_active_jobs").addClass("text-muted");
    $("#side_active_jobs").css({ background: "none", opacity: 1 });
  ...
  if (
    window.location.href.indexOf("?view_type=interviews&status=closed") > -1
  ) {
    $("#side_active_jobs").removeClass("active");
    $("#side_active_jobs").addClass("text-muted");
    $("#side_active_jobs").css({ background: "none", opacity: 1 });
  ...
  if (
    window.location.href.indexOf("?view_type=short_listed&status=deactivated") >
    -1
  ) {
    $("#side_active_jobs").removeClass("active");
    $("#side_active_jobs").addClass("text-muted");
  ...
  if (
    window.location.href.indexOf("?view_type=interviews&status=deactivated") >
    -1
  ) {
    $("#side_active_jobs").removeClass("active");
    $("#side_active_jobs").addClass("text-muted");
  ...
  if (
    window.location.href.indexOf("?view_type=offered&status=deactivated") > -1
  ) {
    $("#side_active_jobs").removeClass("active");
    $("#side_active_jobs").addClass("text-muted");
    $("#side_active_jobs").css({ background: "none", opacity: 1 });
      ...
      .done(function (data) {
        if (data.data !== null) {
          ...
          $.each(data.data, function (key, value) {
            ...
            html += "</div><!--./col-->";
            html +=
              '<div class="col align-self-center" style="min-width:1in;">';
            html +=
              '<a href="' +
              view_url +
              value.id +
            ...
            if ($(window).width() <= 1440 && $(window).width() >= 1380) {
              ...
              if (company_placeholder_length > 20) {
                ...
                html +=
                  '<div class="col align-self-center"><h5 style="font-size: 15px; font-weight: 400; font-family: Be Vietnam Pro, sans-serif; margin-top: auto; margin-bottom: auto;" class="text-break" data-ajacompany="' +
                  value.company_name +
                  '">';
              ...
              if (job_title_placeholder_length > 22) {
                job_title_placeholder = job_title_placeholder + "...";
                html +=
                  '<div class="col align-self-center"><h5 class="text-break" style="font-size: 15px; font-weight: 400; font-family: Be Vietnam Pro, sans-serif; margin-top: auto; margin-bottom: auto;" data-ajacurrjob="' +
                  value.current_job +
                  '">';
                html += job_title_placeholder;
                html += "</h5></div><!--./col-->";
