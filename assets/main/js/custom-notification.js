    ...
    load_notification(function(res){
        ...
        for(const k in res.data){
            ...
            if(data.record_type == 'job_post'){
                ...
                html += '<a notif-id="'+data.id+'" data-schedule_status="'+data.schedule_status+'" target="_blank" class="dropdown-item notif-item" href="'+url+'">'+new_badge+' '+data.short_message+'</a>';
                ...
                html += '<a notif-id="'+data.id+'" data-schedule_status="'+data.schedule_status+'" target="_blank" class="dropdown-item notif-item" data-toggle="modal" data-target="#notification_modal" data-id="'+data.id+'" data-message="'+btoa(data.message)+'" data-employer="'+btoa(data.employer)+'" data-type="'+data.record_type+'" data-status="'+data.status+'">'+new_badge+' '+data.short_message+'</a>';
            }//end if
        ...
        load_notification(function(res){
            ...
            for(const k in res.data){
                ...
                if(data.record_type == 'job_post'){
                    ...
                    //html += '<a href="#" notif-id="'+data.id+'" target="_blank" class="dropdown-item notif-item" data-toggle="modal" data-target="#notification_modal" data-id="'+data.id+'" data-message="'+data.message+'" >'+new_badge+' '+data.short_message+'</a>';
                    html += '<a notif-id="'+data.id+'" target="_blank" class="dropdown-item notif-item" data-toggle="modal" data-target="#notification_modal" data-id="'+data.id+'" data-message="'+btoa(data.message)+'" data-employer="'+btoa(data.employer)+'" data-type="'+data.record_type+'" data-status="'+data.status+'">'+new_badge+' '+data.short_message+'</a>';
                }//end if
        ...
        var final_html = '';
            final_html += '<div class="card">';
                ...
                final_html += '<div class="card-body">';
                    final_html += '<h5 class="modal-title '+card_class+'">'+toPascalCase(status)+'</h5>';
                    final_html += message;
                final_html += '</div>';
            final_html += '</div>';
