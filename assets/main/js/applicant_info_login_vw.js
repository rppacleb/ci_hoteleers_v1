...
$(document).ready(function(){
    ...
    if(type == "view") {
        ...
        if ($(window).width() <= 1024) {
            $('.desktop-aivwmobilenumber').empty();
            $('.mobile-aivwmobilenumber-edit').empty();
            $('.mobile-aivwmobilenumber-view').css('display', 'flex');
        } else {
            $('.aivw-mobcode').css('width', '10.3333%');
            $('.mobile-aivwmobilenumber-edit').empty();
            $('.mobile-aivwmobilenumber-view').empty();
        }
    }
    ...
    var homeurl         = baseurl + '/applicant_info_login';
    var homeurl_txt     = 'applicant_info_login';
                ...
                if(param.mode == 'edit' || param.mode == 'view'){
                    ...
                    //----------------------------------------------------------------------------------------------------
                        ...
                        for(var key in data_lines){
                            html += '<div class="card mb-2">';
                                ...
                                html += '<label class="col-4 col-sm-4 col-md-5 col-lg-3 col-xl-3 col-form-label text-right align-self-center">Position <span class="text-danger fw-bolder">*</span></label>';
                                ...
                                html += '<div class="form-group row">';
                                if ($(window).width() <= 1024) {
                                    html += '<label class="col-4 col-sm-4 col-md-5 col-lg-3 col-xl-3 col-form-label text-right align-self-center">Company <br/> Name <span class="text-danger fw-bolder">*</span></label>';
                                } else {
                                    html += '<label class="col-4 col-sm-4 col-md-5 col-lg-3 col-xl-3 col-form-label text-right align-self-center">Company Name <span class="text-danger fw-bolder">*</span></label>';
                                }
                                    html += '<div class="col-8 col-sm-8 col-md-6 col-lg-8 col-xl-8 align-self-center">';
                                ...
                                html += '<div class="form-group row">';
                                    html += '<label class="col-4 col-sm-4 col-md-5 col-lg-3 col-xl-3 col-form-label text-right">Short description</label>';
                                    html += '<div class="col-8 col-sm-8 col-md-6 col-lg-8 col-xl-8">';
                                        html += '<textarea class="form-control form-control-sm aivw-textarea" name="row_experience[short_description][]" maxlength="600">'+data_lines[key]['short_description']+'</textarea>';
                                    html += '</div><!--./col-10-->';
                                html += '</div><!--./form-group-->';

                                if ($(window).width() <= 1024) {
                                    html += '<div class="form-group row">';
                                        html += '<label class="col-4 col-sm-4 col-md-5 col-lg-3 col-xl-3 col-form-label text-right align-self-center">Start Date</label>';
                                        html += '<div class="col-8 col-sm-8 col-md-6 col-lg-8 col-xl-8 align-self-center">';
                                    ...
                                    html += '<div class="form-group row">';
                                        html += '<label class="col-4 col-sm-4 col-md-5 col-lg-3 col-xl-3 col-form-label text-right align-self-center">End Date</label>';
                                        html += '<div class="col-8 col-sm-8 col-md-6 col-lg-8 col-xl-8 align-self-center">';
                                ...
                                html += '<div class="form-group row">';
                                    html += '<label class="col-4 col-sm-4 col-md-5 col-lg-3 col-xl-3 col-form-label text-right align-self-center">If Current</label>';
                    ...
                    for(var key in data_lines){
                        html += '<div class="card mb-2">';
                            ...
                            html += '<div class="card-body">';
                                ...
                                html += '<div class="form-group row d-none">';
                                    html += '<label class="col-4 col-form-label text-link">Line <span class="text-danger fw-bolder">*</span></label>';
                                    html += '<div class="col">';
                                ...
                                html += '<div class="form-group row">';
                                    html += '<label class="col-4 col-form-label text-link"><span class="text-danger fw-bolder">*</span></label>';
                                    html += '<div class="col">';
                    ...
                    for(var key in data_lines){
                        html += '<div class="card mb-2">';
                            ...
                            html += '<div class="card-body">';
                                ...
                                html += '<div class="form-group row">';
                                    html += '<label class="col-4 col-form-label text-link">University/School <span class="text-danger fw-bolder">*</span></label>';
                                    html += '<div class="col">';
                                ...
                                html += '<div class="form-group row">';
                                    html += '<label class="col-4 col-form-label text-link">Degree/Field of Study <span class="text-danger fw-bolder">*</span></label>';
                                    html += '<div class="col">';
                    ...
                    for(var key in data_lines){
                        html += '<div class="card mb-2">';
                            ...
                            html += '<div class="card-body">';
                                ...
                                html += '<div class="form-group row">';
                                    html += '<label class="col-4 col-sm-4 col-md-5 col-lg-3 col-xl-3 col-form-label text-right align-self-center">Industry <span class="text-danger fw-bolder">*</span></label>';
                                    html += '<div class="col-8 col-sm-8 col-md-6 col-lg-8 col-xl-8 align-self-center">';
                    ...
                    for(var key in data_lines){
                        ...
                        html += '<div class="card-body">';
                            ...
                            html += '<div class="form-group row">';
                                html += '<label class="col-4 col-sm-4 col-md-5 col-lg-3 col-xl-3 col-form-label text-right align-self-center">Job Level <span class="text-danger fw-bolder">*</span></label>';
                                html += '<div class="col-8 col-sm-8 col-md-6 col-lg-8 col-xl-8 align-self-center">';
                                    html += '<div class="input-group input-group-sm aivw-withsel">';
                    ...
                    for(var key in data_lines){
                        ...
                        html += '<div class="card-body">';
                            ...
                            html += '<div class="form-group row">';
                                html += '<label class="col-4 col-sm-4 col-md-5 col-lg-3 col-xl-3 col-form-label text-right align-self-center">Job Type <span class="text-danger fw-bolder">*</span></label>';
                                html += '<div class="col-8 col-sm-8 col-md-6 col-lg-8 col-xl-8 align-self-center">';
                                    html += '<div class="input-group input-group-sm aivw-withsel">';
                    ...
                    for(var key in data_lines){
                        ...
                        html += '<div class="card-body">';
                            ...
                            html += '<div class="form-group row">';
                                html += '<label class="col-4 col-sm-4 col-md-5 col-lg-3 col-xl-3 col-form-label text-right align-self-center">Department<span class="text-danger fw-bolder">*</span></label>';
        ...
        var html = '';
            ...
            html += '<div class="card mb-2">';
                ...
                html += '<div class="card-body">';
                    ...
                    html += '<div class="form-group row">';
                        html += '<label class="col-4 col-form-label text-link">Position <span class="text-danger fw-bolder">*</span></label>';
                        html += '<div class="col">';
                    ...
                    html += '<div class="form-group row">';
                        html += '<label class="col-4 col-form-label text-link">Company Name <span class="text-danger fw-bolder">*</span></label>';
                        html += '<div class="col">';
                    ...
                    html += '<div class="form-group row">';
                        html += '<label class="col-4 col-form-label text-link">If Current</label>';
                        html += '<div class="col">';
                            html += '<input type="checkbox" checked value="false" id="row_experience[if_current][]"/>';
                        html += '</div><!--./col-10-->';
                    html += '</div><!--./form-group-->';
        ...
        var html = '';
            ...
            html += '<div class="card mb-2">';
                ...
                html += '<div class="card-body">';
                    ...
                    html += '<div class="form-group row">';
                        html += '<label class="col-4 col-form-label text-link">Industry <span class="text-danger fw-bolder">*</span></label>';
                        html += '<div class="col">';
                            html += '<div class="input-group input-group-sm">';
        ...
        var html = '';
            html += '<div class="card mb-2">';
                ...
                html += '<div class="card-body">';
                    ...
                    html += '<div class="form-group row">';
                        html += '<label class="col-4 col-form-label text-link">Job Level <span class="text-danger fw-bolder">*</span></label>';
                        html += '<div class="col">';
                            html += '<div class="input-group input-group-sm">';
        ...
        var html = '';
            html += '<div class="card mb-2">';
                ...
                html += '<div class="card-body">';
                    ...
                    html += '<div class="form-group row">';
                        html += '<label class="col-4 col-form-label text-link">Job Type <span class="text-danger fw-bolder">*</span></label>';
                        html += '<div class="col">';
                            html += '<div class="input-group input-group-sm">';
        ...
        var html = '';
            html += '<div class="card mb-2">';
                ...
                html += '<div class="card-body">';
                    ...
                    html += '<div class="form-group row">';
                        html += '<label class="col-4 col-form-label text-link">Department <span class="text-danger fw-bolder">*</span></label>';
                        html += '<div class="col">';
                            html += '<div class="input-group input-group-sm">';
