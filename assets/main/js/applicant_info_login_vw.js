      ...
      .done(function (response) {
        if (response.data !== null && response.data !== undefined) {
          ...
          if (param.mode == "edit" || param.mode == "view") {
            ...
            $("#frm_data_entry select[name=header\\[dial_code\\]]").multiselect(
              "select",
              data.dial_code
            );
            ...
            var rows = str.split(/\r\n|\r|\n/).length;
            rows += 8;
            $("#frm_data_entry textarea[name=header\\[highlights\\]]").attr(
              "rows",
              rows
            );
            ...
            for (var key in data_lines) {
              ...
              html +=
                '<label class="col-4 col-sm-4 col-md-5 col-lg-3 col-xl-3 col-form-label text-right align-self-center">Position <span class="text-danger fw-bolder">*</span></label>';
              html +=
              ...
              if ($(window).width() <= 1024) {
                html +=
                  '<label class="col-4 col-sm-4 col-md-5 col-lg-3 col-xl-3 col-form-label text-right align-self-center">Company <br/> Name <span class="text-danger fw-bolder">*</span></label>';
              } else {
                html +=
                  '<label class="col-4 col-sm-4 col-md-5 col-lg-3 col-xl-3 col-form-label text-right align-self-center">Company Name <span class="text-danger fw-bolder">*</span></label>';
              }
              html +=
                '<div class="col-8 col-sm-8 col-md-6 col-lg-8 col-xl-8 align-self-center">';
              html +=
              ...
              html += '<div class="form-group row">';
              html +=
                '<label class="col-4 col-sm-4 col-md-5 col-lg-3 col-xl-3 col-form-label text-right">Short description</label>';
              html += '<div class="col-8 col-sm-8 col-md-6 col-lg-8 col-xl-8">';
              html +=
                '<textarea class="form-control form-control-sm aivw-textarea" name="row_experience[short_description][]" maxlength="600">' +
              ...
              if ($(window).width() <= 1024) {
                html += '<div class="form-group row">';
                html +=
                  '<label class="col-4 col-sm-4 col-md-5 col-lg-3 col-xl-3 col-form-label text-right align-self-center">Start Date</label>';
                html +=
                  '<div class="col-8 col-sm-8 col-md-6 col-lg-8 col-xl-8 align-self-center">';
                ...
                html += '<div class="form-group row">';
                html +=
                  '<label class="col-4 col-sm-4 col-md-5 col-lg-3 col-xl-3 col-form-label text-right align-self-center">End Date</label>';
                html +=
                  '<div class="col-8 col-sm-8 col-md-6 col-lg-8 col-xl-8 align-self-center">';
              ...
              html += '<div class="form-group row">';
              html +=
                '<label class="col-4 col-sm-4 col-md-5 col-lg-3 col-xl-3 col-form-label text-right align-self-center">If Current</label>';
            ...
            for (var key in data_lines) {
              ...
              html += '<div class="form-group row">';
              html +=
                '<label class="col-4 col-form-label text-link">Start Date</label>';
              html += '<div class="col">';
              html += '<div class="input-group input-group-sm">';
              html +=
                '<input value="' +
              ...
              html += '<div class="form-group row">';
              html +=
                '<label class="col-4 col-form-label text-link">End Date</label>';
              html += '<div class="col">';
              html += '<div class="input-group input-group-sm date">';
              html +=
                '<input value="' +
              ...
              html += '<div class="form-group row">';
              html +=
                '<label class="col-4 col-form-label text-link">If Current</label>';
              html += '<div class="col">';
              html +=
                "<input " +
                (data_lines[key]["if_current"] == 1 ? "checked" : "") +
                ' type="checkbox" id="row_education[if_current][]"/>';
              html += "</div><!--./col-10-->";
              html += "</div><!--./form-group-->";
            ...
            for (var key in data_lines) {
              ...
              html += '<div class="form-group row">';
              html +=
                '<label class="col-4 col-sm-4 col-md-5 col-lg-3 col-xl-3 col-form-label text-right align-self-center">Industry <span class="text-danger fw-bolder">*</span></label>';
              html +=
                '<div class="col-8 col-sm-8 col-md-6 col-lg-8 col-xl-8 align-self-center">';
            ...
            for (var key in data_lines) {
              ...
              html += '<div class="form-group row">';
              html +=
                '<label class="col-4 col-sm-4 col-md-5 col-lg-3 col-xl-3 col-form-label text-right align-self-center">Job Level <span class="text-danger fw-bolder">*</span></label>';
              html +=
                '<div class="col-8 col-sm-8 col-md-6 col-lg-8 col-xl-8 align-self-center">';
              html += '<div class="input-group input-group-sm aivw-withsel">';
              html +=
            ...
            for (var key in data_lines) {
              ...
              html += '<div class="form-group row">';
              html +=
                '<label class="col-4 col-sm-4 col-md-5 col-lg-3 col-xl-3 col-form-label text-right align-self-center">Job Type <span class="text-danger fw-bolder">*</span></label>';
              html +=
                '<div class="col-8 col-sm-8 col-md-6 col-lg-8 col-xl-8 align-self-center">';
              html += '<div class="input-group input-group-sm aivw-withsel">';
              html +=
            ...
            for (var key in data_lines) {
              ...
              html += '<div class="form-group row">';
              html +=
                '<label class="col-4 col-sm-4 col-md-5 col-lg-3 col-xl-3 col-form-label text-right align-self-center">Department<span class="text-danger fw-bolder">*</span></label>';
              html +=
