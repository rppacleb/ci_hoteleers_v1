...
$(document).ready(function(){
    ...
    var homeurl     = baseurl + '/deactivated_jobs';
    var homeurl_txt = 'deactivated_jobs';
                                ...
                                html += '<div class="card">';
                                    html += '<div class="card-body">';
                                        html += '<div class="row">';
                                            ...
                                            //html += '</div><!--./col-->';
                                            html += '<div class="col-1 align-self-center text-muted text-left" style="min-width:0.5in;">';
                                                html += value.id;
                                            html += '</div><!--./col-->';
                                            html += '<div class="col align-self-center text-link" style="min-width:1in;">';
                                                //html += value.job_title;
                                                html += '<a style="text-decoration:none;" href="'+view_url+value.id+'&status=deactivated&mod_type=side_deactivated" class="text-link">'+job_title_placeholder+'</a>';
                                            html += '</div><!--./col-->';
                                            ...
                                            html += '</div><!--./col-->';
                                            html += '<div class="col align-self-center text-muted text-center">';
                                            ...
                                            html += '</div><!--./col-->';
                                            html += '<div class="col-xl-2 col-lg-2 align-self-center text-center" style="min-width:1.5in;">';
                                                ...
                                                //html += '<div class="btn-group btn-group-toggle">';
                                                    ...
                                                    html += '<button type="button" title="Copy" onclick="window.open('+"'"+job_post_copy_url+value.id+"'"+',\'newwindow\',\'width='+w+',height='+h+',status=0,left='+l+',top='+t+'\'); return false;" data-id="'+value.id+'" class="mr-2 btn btn-pill-sm btn-pill-sm-outline-light text-muted mr-1 btn_save"><i class="fa fa-copy"></i></button>';
                                                    //html += '<a href="#" class="btn btn-pill-sm btn-pill-outline-link text-link btn_save">Save</a>';
                                                    html += '<a href="'+view_url+value.id+'&status=deactivated&mod_type=side_deactivated" class="btn btn-pill-sm btn-pill-outline-link text-link btn_view">View</a>';
