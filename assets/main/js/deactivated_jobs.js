      ...
      .done(function (data) {
        if (data.data !== null) {
          ...
          $.each(data.data, function (key, value) {
            ...
            //html += '</div><!--./col-->';
            html +=
              '<div class="col-1 align-self-center text-muted text-left" style="min-width:0.5in;">';
            html += value.id;
            html += "</div><!--./col-->";
            html +=
            ...
            html +=
              ...
              view_url +
              value.id +
              '&status=deactivated&mod_type=side_deactivated" class="text-link">' +
            ...
            html +=
              '<button type="button" title="Copy" onclick="window.open(' +
              "'" +
              job_post_copy_url +
              value.id +
              "'" +
              ...
              value.id +
              '" class="mr-2 btn btn-pill-sm btn-pill-sm-outline-light text-muted mr-1 btn_save"><i class="fa fa-copy"></i></button>';
            //html += '<a href="#" class="btn btn-pill-sm btn-pill-outline-link text-link btn_save">Save</a>';
            html +=
              '<a href="' +
              view_url +
              value.id +
              '&status=deactivated&mod_type=side_deactivated" class="btn btn-pill-sm btn-pill-outline-link text-link btn_view">View</a>';
