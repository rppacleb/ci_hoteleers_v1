                        ...
                        html += '<div class="col-3" style="float:left;">';
                          html += '<div class="card mb-2" style="min-height:4.2in;">';
                            ...
                            html += '<div class="card-body">';
                                html += '<a href="'+view_url+value.id+'" style="text-decoration:none;"><h5 class="text-link">'+value.job_title+'</h5></a>';

                                html += '<div class="mb-0">';
                                    html += '<small class="text-muted" style="font-size:9pt !important"><b>'+value.company_name+'</b></small>';
                                html += '</div>';
                                 html += '<div class="mb-0">';
                                ...
                                html += '<div class="row mb-2">';
                                    html += '<div class="col ">';
                                        ...
                                        if(user_id !== 0){
                                            ...
                                            html += '<a href="'+not_loggedin+value.id+'" class="mr-3 btn btn-pill-sm '+btn_attr+'" aria-saved="'+parseInt(value.saved)+'" aria-id="'+value.id+'"><i class="fa fa-heart"></i></a>';
