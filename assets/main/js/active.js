$(document).ready(function () {
  //highlight
  $("#side_account_management_active").removeClass("text-muted");
  $("#side_account_management_active").addClass("active");
  $("#side_account_management_active").css({
    opacity: 0.8,
  ...
  function load_record(page, type, container, pagination, loader, callback) {
    ...
    var url = baseurl + "/get/active/" + type;
    $.ajax({
      url: url,
      type: "POST",
      data: data,
      ...
      .done(function (data) {
        if (data.data !== null) {
          ...
          $.each(data.data, function (key, value) {
            ...
            html +=
              '<div class="text-center col-xl-1 col-lg-1 col-md-12 col-sm-12 col-xs-12 align-self-center" style="min-width:1in;">';

            html +=
              '<a href="' +
              view_url +
              value.id +
              '?side_menu=side_account_management_active&type=active" class="text-link btn_view" style="padding: 0rem;">View</a>';
